...
// GAMES:BEGIN
  ...
  'ball-blast', 'balloon-pop', 'barrel-climb', 'battleship', 'blackjack', 'blast-arena',
  'blob-eater', 'block-stacker', 'blockcraft', 'bowling', 'box-push', 'brick-breaker',
  'bubble-pop', 'bug-blaster', 'cannon-siege', 'cave-flyer', 'checkers', 'chess-blitz',
  'coin-tycoon', 'color-rush', 'connect-four', 'crazy-eights', 'darts', 'dash-runner',
  'dot-connect', 'dots-and-boxes', 'farm-idle', 'flap-rocket', 'freecell', 'fruit-slice',
  'g2048', 'galaxy-raid', 'gem-swap', 'golf-solitaire', 'gomoku', 'gravity-swap', 'hangman',
  'helix-drop', 'highway-rush', 'hole-eater', 'hoop-shot', 'ice-slide', 'jump-quest',
  'klondike', 'knife-throw', 'laser-maze', 'lava-run', 'letter-drop', 'lights-out',
  ...
  'missile-defense', 'neon-snake', 'nim', 'nine-mens-morris', 'nonogram', 'one-line',
  'paper-claim', 'peg-solitaire', 'penalty-shootout', 'perfect-circle', 'piano-tap', 'pinball',
  'plinko', 'pong-duel', 'pyramid-solitaire', 'quick-math', 'reaction-time', 'reversi',
  'rhythm-tap', 'rise-up', 'road-hopper', 'simon-says', 'sky-hopper', 'slide-puzzle',
