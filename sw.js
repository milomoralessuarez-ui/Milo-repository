...
// GAMES:BEGIN
  ...
  'ball-blast', 'balloon-pop', 'battleship', 'blackjack', 'blast-arena', 'blob-eater',
  'block-stacker', 'blockcraft', 'bowling', 'box-push', 'brick-breaker', 'bubble-pop',
  'cannon-siege', 'cave-flyer', 'checkers', 'coin-tycoon', 'color-rush', 'connect-four',
  'crazy-eights', 'darts', 'dash-runner', 'dots-and-boxes', 'flap-rocket', 'freecell',
  'fruit-slice', 'g2048', 'gem-swap', 'golf-solitaire', 'gomoku', 'gravity-swap', 'hangman',
  'helix-drop', 'highway-rush', 'hoop-shot', 'jump-quest', 'klondike', 'knife-throw',
