...
// GAMES:BEGIN
  ...
  'crazy-eights', 'darts', 'dash-runner', 'dot-connect', 'dots-and-boxes', 'farm-idle',
  'flap-rocket', 'fling-fortress', 'freecell', 'fruit-slice', 'futoshiki', 'g2048',
  ...
  'jump-quest', 'key-quest', 'klondike', 'knife-throw', 'laser-dodge', 'laser-maze', 'lava-run',
  ...
  'mini-golf', 'missile-defense', 'neon-snake', 'nim', 'nine-mens-morris', 'ninja-climb',
  'nonogram', 'one-line', 'paper-claim', 'peg-solitaire', 'penalty-shootout', 'perfect-circle',
  'piano-tap', 'pinball', 'plinko', 'pong-duel', 'pyramid-solitaire', 'quick-math',
  'reaction-time', 'reversi', 'rhythm-tap', 'rise-up', 'road-hopper', 'roll-block',
  'rolling-ball', 'simon-says', 'sky-hopper', 'slide-puzzle', 'snake-royale', 'space-defender',
  'space-trader', 'spider-solitaire', 'spot-difference', 'stack-ball', 'sudoku', 'sweet-match',
  'tank-arena', 'terra-dig', 'tic-tac-toe', 'tile-match', 'tower-defence', 'tower-of-hanoi',
  'tower-stack', 'turbo-drift', 'typing-test', 'ultimate-ttt', 'video-poker', 'war-cards',
