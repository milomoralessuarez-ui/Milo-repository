...
// GAMES:BEGIN
  ...
  'ice-slide', 'jump-quest', 'kart-sprint', 'key-quest', 'klondike', 'knife-throw',
  'laser-dodge', 'laser-duel', 'laser-maze', 'lava-run', 'letter-drop', 'lights-out',
  'lunar-lander', 'make-24', 'mancala', 'mastermind', 'math-blitz', 'maze-muncher',
  'maze-runner', 'mech-storm', 'memory-match', 'memory-sequence', 'merge-drop', 'meteor-surf',
  'minesweeper', 'mini-golf', 'missile-defense', 'moto-hill', 'neon-snake', 'night-rider',
  'nim', 'nine-mens-morris', 'ninja-climb', 'nonogram', 'one-line', 'orbital-defense',
  'paint-wars', 'paper-claim', 'peg-solitaire', 'penalty-shootout', 'perfect-circle',
  'piano-tap', 'pinball', 'plinko', 'polly-track', 'pong-duel', 'pyramid-solitaire',
  'quick-math', 'quiz-pack-1', 'quiz-pack-2', 'reaction-time', 'reversi', 'rhythm-tap',
  'rise-up', 'river-raft', 'road-hopper', 'roll-block', 'rolling-ball', 'rooftop-run',
  'shadow-leap', 'simon-says', 'skate-park', 'ski-slalom', 'sky-ace', 'sky-hopper',
  'slide-puzzle', 'snake-royale', 'space-defender', 'space-trader', 'spider-solitaire',
  'spike-dash', 'spot-difference', 'stack-ball', 'submarine-strike', 'sudoku', 'sweet-match',
