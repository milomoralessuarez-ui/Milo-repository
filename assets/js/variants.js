/* ==========================================================================
   ...
   Generated by tools/build-variants.mjs; 601 remixes.
   ========================================================================== */
(function () {
  'use strict';
  ...
  V('aim-trainer', { id: 'aim-trainer-hyper', title: 'Aim Trainer Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Aim Trainer Hyper is Aim Trainer with the clock running 70% faster. One target at a time, thirty seconds on the clock. Hitting a target instantly spawns the next one — slightly smaller. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Aim Trainer record.',
  ...
  V('aim-trainer', { id: 'aim-trainer-insane', title: 'Aim Trainer: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Aim Trainer, twice as fast. One target at a time, thirty seconds on the clock. Hitting a target instantly spawns the next one — slightly smaller. Insane is the top of the remix ladder: past this there is nothing, so a personal best here is the one to brag about. Scores are kept apart from the original and the other remixes.',
  ...
  V('aim-trainer', { id: 'aim-trainer-zen', title: 'Aim Trainer Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Aim Trainer, tinted cool. One target at a time, thirty seconds on the clock. Hitting a target instantly spawns the next one — slightly smaller. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('air-hockey', { id: 'air-hockey-hyper', title: 'Air Hockey Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Air Hockey at 1.7× speed. Drag your mallet around your half of the table. The puck picks up your mallet’s own speed on contact, so a moving strike is far more dangerous than a stationary block. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('air-hockey', { id: 'air-hockey-insane', title: 'Air Hockey: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Air Hockey: Insane Mode runs Air Hockey at exactly double speed. Drag your mallet around your half of the table. The puck picks up your mallet’s own speed on contact, so a moving strike is far more dangerous than a stationary block. Everything the original does, it does twice as fast — including the difficulty ramp — so this is less a game to beat than a game to survive, and a run that lasts thirty seconds is genuinely good. Own best score, warm palette.',
  ...
  V('air-hockey', { id: 'air-hockey-zen', title: 'Air Hockey Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Air Hockey: identical rules, 28% slower, separate high score. Drag your mallet around your half of the table. The puck picks up your mallet’s own speed on contact, so a moving strike is far more dangerous than a stationary block. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('alien-swarm', { id: 'alien-swarm-hyper', title: 'Alien Swarm Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Alien Swarm: same mechanics, 1.7× game speed, separate leaderboard. A twin-stick shooter where the second stick is automatic: your cannon always fires at the nearest alien, so the whole game is positioning. Chevron drones flock straight at you, green spitters hang back and lob globs, and rose hulks soak a dozen hits. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('alien-swarm', { id: 'alien-swarm-insane', title: 'Alien Swarm: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Alien Swarm: identical mechanics, game time × 2, warm palette, separate best score. A twin-stick shooter where the second stick is automatic: your cannon always fires at the nearest alien, so the whole game is positioning. Chevron drones flock straight at you, green spitters hang back and lob globs, and rose hulks soak a dozen hits. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
  ...
  V('alien-swarm', { id: 'alien-swarm-zen', title: 'Alien Swarm Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Alien Swarm at a gentler pace. A twin-stick shooter where the second stick is automatic: your cannon always fires at the nearest alien, so the whole game is positioning. Chevron drones flock straight at you, green spitters hang back and lob globs, and rose hulks soak a dozen hits. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Alien Swarm.',
  ...
  V('anagram-hunt', { id: 'anagram-hunt-insane', title: 'Anagram Hunt: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Anagram Hunt at 2× — the version for people who found Hyper too polite. Ninety seconds, one scrambled word at a time. Type the answer and hit Enter. At double speed reaction is barely enough; runs are won by knowing what comes next before it appears. Separate leaderboard so the numbers stay honest.',
  ...
  V('anagram-hunt', { id: 'anagram-hunt-zen', title: 'Anagram Hunt Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Anagram Hunt Zen slows Anagram Hunt to about three-quarter speed and gives it a calmer palette. Ninety seconds, one scrambled word at a time. Type the answer and hit Enter. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('archery', { id: 'archery-hyper', title: 'Archery Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Archery: same mechanics, 1.7× game speed, separate leaderboard. Drag back from the bow to set power and angle, and a dotted arc shows roughly where the arrow will land — accounting for both gravity and the crosswind, which is shown at the top. The target shrinks and starts drifting as the rounds go on. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('archery', { id: 'archery-insane', title: 'Archery: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Archery: identical mechanics, game time × 2, warm palette, separate best score. Drag back from the bow to set power and angle, and a dotted arc shows roughly where the arrow will land — accounting for both gravity and the crosswind, which is shown at the top. The target shrinks and starts drifting as the rounds go on. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
  ...
  V('archery', { id: 'archery-zen', title: 'Archery Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Archery at a gentler pace. Drag back from the bow to set power and angle, and a dotted arc shows roughly where the arrow will land — accounting for both gravity and the crosswind, which is shown at the top. The target shrinks and starts drifting as the rounds go on. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Archery.',
  ...
  V('arrow-storm', { id: 'arrow-storm-hyper', title: 'Arrow Storm Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Arrow Storm Hyper is Arrow Storm with the clock running 70% faster. You are the last archer on a rain-lashed castle wall. Hold to draw — power grows for a second — and release to loose an arrow that flies a true gravity arc. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Arrow Storm record.',
  ...
  V('arrow-storm', { id: 'arrow-storm-insane', title: 'Arrow Storm: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Arrow Storm, twice as fast. You are the last archer on a rain-lashed castle wall. Hold to draw — power grows for a second — and release to loose an arrow that flies a true gravity arc. Insane is the top of the remix ladder: past this there is nothing, so a personal best here is the one to brag about. Scores are kept apart from the original and the other remixes.',
  ...
  V('arrow-storm', { id: 'arrow-storm-zen', title: 'Arrow Storm Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Arrow Storm, tinted cool. You are the last archer on a rain-lashed castle wall. Hold to draw — power grows for a second — and release to loose an arrow that flies a true gravity arc. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('asteroid-field', { id: 'asteroid-field-hyper', title: 'Asteroid Field Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Asteroid Field Hyper is Asteroid Field with the clock running 70% faster. Your ship has thrust and inertia but no brakes — pointing where you want to go is only half the problem. Shooting a big rock splits it into two mediums and each of those into two smalls, so a full wave gets much busier before it clears. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Asteroid Field record.',
  ...
  V('asteroid-field', { id: 'asteroid-field-insane', title: 'Asteroid Field: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Asteroid Field, twice as fast. Your ship has thrust and inertia but no brakes — pointing where you want to go is only half the problem. Shooting a big rock splits it into two mediums and each of those into two smalls, so a full wave gets much busier before it clears. Insane is the top of the remix ladder: past this there is nothing, so a personal best here is the one to brag about. Scores are kept apart from the original and the other remixes.',
  ...
  V('asteroid-field', { id: 'asteroid-field-zen', title: 'Asteroid Field Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Asteroid Field, tinted cool. Your ship has thrust and inertia but no brakes — pointing where you want to go is only half the problem. Shooting a big rock splits it into two mediums and each of those into two smalls, so a full wave gets much busier before it clears. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('astro-blaster', { id: 'astro-blaster-hyper', title: 'Astro Blaster Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Astro Blaster at 1.7× speed. Fly your ship, shoot down wave after wave of hostiles and dodge their return fire. Green power-ups upgrade your gun to spread and then to a four-way cannon; red ones give a spare life. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('astro-blaster', { id: 'astro-blaster-insane', title: 'Astro Blaster: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Astro Blaster: Insane Mode runs Astro Blaster at exactly double speed. Fly your ship, shoot down wave after wave of hostiles and dodge their return fire. Green power-ups upgrade your gun to spread and then to a four-way cannon; red ones give a spare life. Everything the original does, it does twice as fast — including the difficulty ramp — so this is less a game to beat than a game to survive, and a run that lasts thirty seconds is genuinely good. Own best score, warm palette.',
  ...
  V('astro-blaster', { id: 'astro-blaster-zen', title: 'Astro Blaster Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Astro Blaster: identical rules, 28% slower, separate high score. Fly your ship, shoot down wave after wave of hostiles and dodge their return fire. Green power-ups upgrade your gun to spread and then to a four-way cannon; red ones give a spare life. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('balance-tower', { id: 'balance-tower-hyper', title: 'Balance Tower Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Balance Tower, seventy percent faster, in a hotter palette. A plank sits on a single pivot and every piece you drop shifts its centre of mass — the red dot shows exactly where that is. Land weight on one side and the plank tilts slowly towards it; past twenty degrees the whole tower slides off. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('balance-tower', { id: 'balance-tower-insane', title: 'Balance Tower: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'The double-speed edition of Balance Tower. A plank sits on a single pivot and every piece you drop shifts its centre of mass — the red dot shows exactly where that is. Land weight on one side and the plank tilts slowly towards it; past twenty degrees the whole tower slides off. Insane keeps every rule intact and simply halves the time you get for each decision; it is brutally short, oddly relaxing once you accept that, and tracked on its own high-score table.',
  ...
  V('balance-tower', { id: 'balance-tower-zen', title: 'Balance Tower Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Balance Tower. A plank sits on a single pivot and every piece you drop shifts its centre of mass — the red dot shows exactly where that is. Land weight on one side and the plank tilts slowly towards it; past twenty degrees the whole tower slides off. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('ball-blast', { id: 'ball-blast-hyper', title: 'Ball Blast Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Ball Blast. Your cannon fires by itself — all you do is move it. Each ball shows how much damage it can still take, and breaking one splits it into two smaller, faster ones. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('ball-blast', { id: 'ball-blast-insane', title: 'Ball Blast: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Ball Blast at 2× — the version for people who found Hyper too polite. Your cannon fires by itself — all you do is move it. Each ball shows how much damage it can still take, and breaking one splits it into two smaller, faster ones. At double speed reaction is barely enough; runs are won by knowing what comes next before it appears. Separate leaderboard so the numbers stay honest.',
  ...
  V('ball-blast', { id: 'ball-blast-zen', title: 'Ball Blast Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Ball Blast Zen slows Ball Blast to about three-quarter speed and gives it a calmer palette. Your cannon fires by itself — all you do is move it. Each ball shows how much damage it can still take, and breaking one splits it into two smaller, faster ones. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('balloon-pop', { id: 'balloon-pop-hyper', title: 'Balloon Pop Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Balloon Pop Hyper is Balloon Pop with the clock running 70% faster. Balloons drift up the screen in five colours, but only one colour counts at a time — and it changes every few pops, so you have to keep reading the banner rather than settling into a rhythm. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Balloon Pop record.',
  ...
  V('balloon-pop', { id: 'balloon-pop-insane', title: 'Balloon Pop: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Balloon Pop, twice as fast. Balloons drift up the screen in five colours, but only one colour counts at a time — and it changes every few pops, so you have to keep reading the banner rather than settling into a rhythm. Insane is the top of the remix ladder: past this there is nothing, so a personal best here is the one to brag about. Scores are kept apart from the original and the other remixes.',
  ...
  V('barrel-climb', { id: 'barrel-climb-hyper', title: 'Barrel Climb Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Barrel Climb, seventy percent faster, in a hotter palette. Climb five sloping girders to the trophy at the top while barrels roll down from the ape. Girders tilt alternately, so barrels zig-zag down the level rather than falling straight. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('barrel-climb', { id: 'barrel-climb-insane', title: 'Barrel Climb: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'The double-speed edition of Barrel Climb. Climb five sloping girders to the trophy at the top while barrels roll down from the ape. Girders tilt alternately, so barrels zig-zag down the level rather than falling straight. Insane keeps every rule intact and simply halves the time you get for each decision; it is brutally short, oddly relaxing once you accept that, and tracked on its own high-score table.',
  ...
  V('basket-fall', { id: 'basket-fall-hyper', title: 'Basket Fall Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Basket Fall: same mechanics, 1.7× game speed, separate leaderboard. Gravity is fixed and the ball is dumb — you steer by rotating the entire maze with two keys. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('basket-fall', { id: 'basket-fall-insane', title: 'Basket Fall: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Basket Fall: identical mechanics, game time × 2, warm palette, separate best score. Gravity is fixed and the ball is dumb — you steer by rotating the entire maze with two keys. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
  ...
  V('batting-cage', { id: 'batting-cage-hyper', title: 'Batting Cage Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Batting Cage. Home-run derby under the floodlights, ten pitches a round. The windup telegraphs what is coming — a quick arm is a fastball, a long pause is a change-up, a high leg kick means the ball will break sideways. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('batting-cage', { id: 'batting-cage-insane', title: 'Batting Cage: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Batting Cage at 2× — the version for people who found Hyper too polite. Home-run derby under the floodlights, ten pitches a round. The windup telegraphs what is coming — a quick arm is a fastball, a long pause is a change-up, a high leg kick means the ball will break sideways. At double speed reaction is barely enough; runs are won by knowing what comes next before it appears. Separate leaderboard so the numbers stay honest.',
  ...
  V('battleship', { id: 'battleship-hyper', title: 'Battleship Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Battleship. Lay out five ships — press R to rotate, or let the game place them — then trade shots. The computer searches in a checkerboard pattern until it lands a hit, then works outward from it, so a wounded ship rarely survives long. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('battleship', { id: 'battleship-insane', title: 'Battleship: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Battleship at 2× — the version for people who found Hyper too polite. Lay out five ships — press R to rotate, or let the game place them — then trade shots. The computer searches in a checkerboard pattern until it lands a hit, then works outward from it, so a wounded ship rarely survives long. At double speed reaction is barely enough; runs are won by knowing what comes next before it appears. Separate leaderboard so the numbers stay honest.',
  ...
  V('binary-puzzle', { id: 'binary-puzzle-insane', title: 'Binary Puzzle: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Binary Puzzle at 2× — the version for people who found Hyper too polite. Every square takes a sun or a moon, under three rules that squeeze the grid from all sides: never three of the same symbol in a row, exactly four of each in every row and column, and no two rows or columns identical. At double speed reaction is barely enough; runs are won by knowing what comes next before it appears. Separate leaderboard so the numbers stay honest.',
  ...
  V('blast-arena', { id: 'blast-arena-insane', title: 'Blast Arena: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Blast Arena at 2× — the version for people who found Hyper too polite. A top-down arena that keeps sending bots at you, more of them and tougher every wave. Move with WASD, aim with the mouse, dash with Shift and put the cover blocks between you and their fire. At double speed reaction is barely enough; runs are won by knowing what comes next before it appears. Separate leaderboard so the numbers stay honest.',
  ...
  V('block-stacker', { id: 'block-stacker-insane', title: 'Block Stacker: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'The double-speed edition of Block Stacker. Seven shapes fall one at a time — rotate and slide them to fill complete rows. A ghost shows exactly where the piece will land, you can hold a piece for later with C, and Space slams it straight down. Insane keeps every rule intact and simply halves the time you get for each decision; it is brutally short, oddly relaxing once you accept that, and tracked on its own high-score table.',
  ...
  V('boat-race', { id: 'boat-race-insane', title: 'Boat Race: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Boat Race: Insane Mode runs Boat Race at exactly double speed. Race a speedboat down a winding river and thread all 26 red-and-green buoy gates before a 60-second clock runs out. Everything the original does, it does twice as fast — including the difficulty ramp — so this is less a game to beat than a game to survive, and a run that lasts thirty seconds is genuinely good. Own best score, warm palette.',
  ...
  V('bomb-catcher', { id: 'bomb-catcher-insane', title: 'Bomb Catcher: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    tagline: 'Catch every bomb — one miss sets off the rest at double speed',
    description: 'Bomb Catcher: Insane Mode runs Bomb Catcher at exactly double speed. A grinning bomber paces the roofline and lobs bombs into the yard, and you slide a stack of three buckets under all of them. Miss one and everything still falling detonates at once, costing you a bucket. Everything the original does, it does twice as fast — including the difficulty ramp — so this is less a game to beat than a game to survive, and a run that lasts thirty seconds is genuinely good. Own best score, warm palette.',
    colors: ['#5f056f', '#dfff45'], tags: ['classic', 'reflex', 'arcade', 'insane', 'remix'] });
  ...
  V('bomb-catcher', { id: 'bomb-catcher-turbo', title: 'Bomb Catcher Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Bomb Catcher. A grinning bomber paces the roofline and lobs bombs into the yard, and you slide a stack of three buckets under all of them. Miss one and everything still falling detonates at once, costing you a bucket. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('bowling', { id: 'bowling-turbo', title: 'Bowling Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Bowling: identical mechanics, 35% more speed, its own leaderboard. Three clicks per throw: the first locks your line as a marker slides across the lane, the second sets power, the third sets spin — and spin builds into a real hook as the ball travels. Pins knock each other over, so a good pocket hit can clear all ten. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('box-fort', { id: 'box-fort-turbo', title: 'Box Fort Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Box Fort. Cardboard boxes drift down from the sky one at a time, landing wherever the red marker points. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('box-push', { id: 'box-push-turbo', title: 'Box Push Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Box Push: identical mechanics, 35% more speed, its own leaderboard. Shove every crate onto a green marker. The catch is that you can only push: once a crate is in a corner or flat against a wall in the wrong place, that level is unwinnable and you will have to undo. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('brick-breaker', { id: 'brick-breaker-hyper', title: 'Brick Breaker Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Brick Breaker Hyper is Brick Breaker with the clock running 70% faster. Bounce the ball off your paddle to clear the wall. Tougher bricks need two or three hits. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Brick Breaker record.',
  ...
  V('bubble-pop', { id: 'bubble-pop-hyper', title: 'Bubble Pop Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Bubble Pop: same mechanics, 1.7× game speed, separate leaderboard. Fire bubbles up into a hanging cluster. Three or more of the same colour touching each other pop — and crucially, anything left dangling with no path back to the ceiling falls as well, which is where the big scores come from. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('bubble-shooter', { id: 'bubble-shooter-hyper', title: 'Bubble Shooter Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Bubble Shooter Hyper is Bubble Shooter with the clock running 70% faster. The classic: aim the cannon, bounce shots off the side walls into gaps you cannot reach straight on, and land three matching bubbles to pop them. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Bubble Shooter record.',
  ...
  V('centipede-strike', { id: 'centipede-strike-hyper', title: 'Centipede Strike Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Centipede Strike, seventy percent faster, in a hotter palette. A twelve-segment crawler winds down a field of teal spores, turning and dropping a row every time something blocks it. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('checkers', { id: 'checkers-hyper', title: 'Checkers Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Checkers. Move diagonally forward one square, or jump an opposing piece to take it. Captures are compulsory and chain, so a single move can clear three pieces off the board. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('chess-blitz', { id: 'chess-blitz-hyper', title: 'Chess Blitz Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Chess Blitz. Full piece movement with check, checkmate and stalemate detection, and pawns that promote to queens. Legal moves are shown as dots when you pick up a piece — red rings mark captures. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('city-idle', { id: 'city-idle-hyper', title: 'City Idle Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of City Idle. A small city on a small grid, where nothing works unless it touches a road. Housing brings residents, shops and factories give them jobs, and a power plant keeps the whole thing lit — run short of any of the three and happiness starts sliding. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('color-flood', { id: 'color-flood-hyper', title: 'Color Flood Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Color Flood at 1.7× speed. Your blob starts as the single top-left cell. Each colour you pick repaints the blob and absorbs every touching cell already wearing that colour, so the trick is picking the shade that opens the biggest corridor rather than the one that grabs most now. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('color-flood', { id: 'color-flood-turbo', title: 'Color Flood Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Color Flood. Your blob starts as the single top-left cell. Each colour you pick repaints the blob and absorbs every touching cell already wearing that colour, so the trick is picking the shade that opens the biggest corridor rather than the one that grabs most now. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('color-flood', { id: 'color-flood-zen', title: 'Color Flood Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Color Flood at a gentler pace. Your blob starts as the single top-left cell. Each colour you pick repaints the blob and absorbs every touching cell already wearing that colour, so the trick is picking the shade that opens the biggest corridor rather than the one that grabs most now. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Color Flood.',
  ...
  V('color-rush', { id: 'color-rush-zen', title: 'Colour Rush Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Colour Rush, tinted cool. Rings made of four coloured quarters spin toward you. Swap your ball to the colour of the quarter you are about to pass through — get it wrong and you burst. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('crazy-eights', { id: 'crazy-eights-zen', title: 'Crazy Eights Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Crazy Eights at a gentler pace. Play a card that matches either the suit or the rank of the top card. Eights are wild: play one and name whatever suit you like. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Crazy Eights.',
  ...
  V('crystal-caverns', { id: 'crystal-caverns-zen', title: 'Crystal Caverns Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Crystal Caverns at a gentler pace. Each cave is one screen: grab every glowing crystal and the exit arch lights up green. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Crystal Caverns.',
  ...
  V('cube-hopper', { id: 'cube-hopper-hyper', title: 'Cube Hopper Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Cube Hopper: same mechanics, 1.7× game speed, separate leaderboard. Twenty-eight cubes make a seven-row pyramid and you hop diagonally across it until every top face has turned the target colour. Rounds three and four need two hops per cube; from round five a third hop turns one back, so route planning matters more than speed. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('cube-hopper', { id: 'cube-hopper-turbo', title: 'Cube Hopper Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Cube Hopper Turbo is Cube Hopper with game time running about a third faster. Twenty-eight cubes make a seven-row pyramid and you hop diagonally across it until every top face has turned the target colour. Rounds three and four need two hops per cube; from round five a third hop turns one back, so route planning matters more than speed. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Cube Hopper.',
  ...
  V('cube-hopper', { id: 'cube-hopper-zen', title: 'Cube Hopper Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Cube Hopper Zen slows Cube Hopper to about three-quarter speed and gives it a calmer palette. Twenty-eight cubes make a seven-row pyramid and you hop diagonally across it until every top face has turned the target colour. Rounds three and four need two hops per cube; from round five a third hop turns one back, so route planning matters more than speed. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('flap-rocket', { id: 'flap-rocket-hyper', title: 'Flap Rocket Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Flap Rocket, seventy percent faster, in a hotter palette. Tap, click or press Space to fire the thruster. Gravity does the rest. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('fling-fortress', { id: 'fling-fortress-hyper', title: 'Fling Fortress Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Fling Fortress, seventy percent faster, in a hotter palette. Haul the sling back, line up the dotted arc and let fly. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('flip-bottle', { id: 'flip-bottle-hyper', title: 'Flip Bottle Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Flip Bottle. A meter sweeps back and forth and one tap throws the bottle at whatever power it was showing. Land in the green band and the bottle comes down flat on its base; nick the gold sliver dead centre and it balances on its cap for triple points. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('flip-bottle', { id: 'flip-bottle-zen', title: 'Flip Bottle Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Flip Bottle, tinted cool. A meter sweeps back and forth and one tap throws the bottle at whatever power it was showing. Land in the green band and the bottle comes down flat on its base; nick the gold sliver dead centre and it balances on its cap for triple points. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('jump-quest', { id: 'jump-quest-turbo', title: 'Jump Quest Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Jump Quest. A straightforward platformer across three hand-built levels. Run and jump between ledges, pick up the coins, avoid the spikes and touch the flag at the end. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('kart-sprint', { id: 'kart-sprint-turbo', title: 'Kart Sprint Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Kart Sprint Turbo is Kart Sprint with game time running about a third faster. A candy-bright cup over three hand-made circuits — Sunny Loop, Snake Valley and the drift-happy Hairpin Ridge — three laps each against Bip, Zola and Rex. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Kart Sprint.',
  ...
  V('key-quest', { id: 'key-quest-turbo', title: 'Key Quest Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Key Quest Turbo is Key Quest with game time running about a third faster. A top-down dungeon built entirely out of locked doors. Keys come in four colours and each one opens a single door of its colour and is then gone, so the room unlocks in a fixed order that you have to work out by exploring. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Key Quest.',
  ...
  V('kitchen-climb', { id: 'kitchen-climb-hyper', title: 'Kitchen Climb Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Kitchen Climb Hyper is Kitchen Climb with the clock running 70% faster. Four burgers are scattered in pieces across five kitchen floors. Walking the full width of a layer knocks it to the floor below, and a layer landing on another sends both onward — a four-floor chain is worth many times four single drops. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Kitchen Climb record.',
  ...
  V('kitchen-climb', { id: 'kitchen-climb-turbo', title: 'Kitchen Climb Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Kitchen Climb, wound up: everything moves at 135% speed and the reaction windows shrink to match. Four burgers are scattered in pieces across five kitchen floors. Walking the full width of a layer knocks it to the floor below, and a layer landing on another sends both onward — a four-floor chain is worth many times four single drops. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Kitchen Climb is worth something on the Turbo leaderboard.',
  ...
  V('kitchen-climb', { id: 'kitchen-climb-zen', title: 'Kitchen Climb Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Kitchen Climb. Four burgers are scattered in pieces across five kitchen floors. Walking the full width of a layer knocks it to the floor below, and a layer landing on another sends both onward — a four-floor chain is worth many times four single drops. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('klondike', { id: 'klondike-turbo', title: 'Klondike Solitaire Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Klondike Solitaire, but hurried. Build all four foundations from Ace up to King. The tableau stacks downwards in alternating colours, only a King can start an empty column, and the stock recycles when you run out. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('knife-throw', { id: 'knife-throw-turbo', title: 'Knife Throw Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Knife Throw, but hurried. Throw knives into a rotating log without hitting one already stuck in it. Every stage adds knives to throw, speeds the spin up and leaves more grey blades in the way — and past stage four the log starts changing speed as it turns. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('laser-dodge', { id: 'laser-dodge-turbo', title: 'Laser Dodge Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Laser Dodge Turbo is Laser Dodge with game time running about a third faster. A single room that keeps filling with light. Every beam warns you first with a thin dotted line, so the whole game is reading the next second and being somewhere else when it arrives. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Laser Dodge.',
  ...
  V('laser-duel', { id: 'laser-duel-turbo', title: 'Laser Duel Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Laser Duel, wound up: everything moves at 135% speed and the reaction windows shrink to match. A one-hit duel against an AI gunslinger, best of five rounds. Every bolt survives two wall bounces, so the strongest play is the shot your opponent never sees coming — banked off a wall or around a pillar, worth 150 instead of 100. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Laser Duel is worth something on the Turbo leaderboard.',
  ...
  V('laser-maze', { id: 'laser-maze-turbo', title: 'Laser Maze Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Laser Maze, but hurried. A beam fires from the left and you steer it by flipping mirrors between their two diagonal orientations. The beam updates live as you click, so you can see exactly where it goes wrong. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('lava-run', { id: 'lava-run-turbo', title: 'Lava Run Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Lava Run, but hurried. A vertical scramble with a rising tide of lava underneath that gets faster the higher you climb. Brown ledges are solid, blue ones slide sideways, orange ones crumble the moment you leave them, and green ones fling you well above a normal jump. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('letter-drop', { id: 'letter-drop-turbo', title: 'Letter Drop Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Letter Drop, but hurried. New rows of letters push up from the bottom on a timer that keeps getting shorter. Click a chain of touching letters — any direction, including diagonals — to spell a word, then press Enter to clear them and drop everything above down. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('lunar-lander', { id: 'lunar-lander-turbo', title: 'Lunar Lander Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Lunar Lander, wound up: everything moves at 135% speed and the reaction windows shrink to match. Gravity is constant and your thruster burns fuel you cannot replace. To land you need all three at once: on a flat pad, close to upright, and slow — the descent and drift readouts turn green when each is safe. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Lunar Lander is worth something on the Turbo leaderboard.',
  ...
  V('magnet-boots', { id: 'magnet-boots-turbo', title: 'Magnet Boots Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Magnet Boots, but hurried. There is no jump. Your boots cling to metal plates, and pressing flip while they are touching one reverses the pull so you fall to the opposite surface — cross a floor full of live wires by walking the ceiling over it. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('make-24', { id: 'make-24-turbo', title: 'Make 24 Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Make 24 Turbo is Make 24 with game time running about a third faster. Combine all four numbers — each used exactly once — with addition, subtraction, multiplication and division to land on exactly 24. Fractions along the way are fine. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Make 24.',
  ...
  V('mancala', { id: 'mancala-turbo', title: 'Mancala Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Mancala. One of the oldest board games there is. Lift all the seeds from one of your pits and drop them one per pit going anticlockwise, skipping the opponent’s store. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('math-blitz', { id: 'math-blitz-turbo', title: 'Math Blitz Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Math Blitz: identical mechanics, 35% more speed, its own leaderboard. Answer as many sums as you can in a minute. Every correct answer adds a second back to the clock and grows your streak multiplier; every wrong one takes two away. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('maze-muncher', { id: 'maze-muncher-turbo', title: 'Maze Muncher Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Maze Muncher, but hurried. Clear every dot in the maze while three ghosts hunt you down. The four big pellets in the corners turn them blue for seven seconds — catch one then and it is worth 200 points and a trip back to its box. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('maze-runner', { id: 'maze-runner-turbo', title: 'Maze Runner Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Maze Runner: identical mechanics, 35% more speed, its own leaderboard. Start top-left, reach the green exit bottom-right. Each maze is generated fresh, and your lantern lights only the corridors near you — so you are mapping it as you go. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('mech-storm', { id: 'mech-storm-turbo', title: 'Mech Storm Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Mech Storm Turbo is Mech Storm with game time running about a third faster. Your mech marches itself down the canyon — you work the jump jets and the arm cannon. Drone squadrons dive from the right while dug-in turrets lob arcing shells you have to jet over. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Mech Storm.',
  ...
  V('memory-sequence', { id: 'memory-sequence-turbo', title: 'Memory Sequence Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Memory Sequence. A 4×4 grid flashes a sequence of squares and you tap them back in order. Each round adds one more step, and longer sequences flash faster — which is what actually breaks people, rather than the length itself. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('merge-drop', { id: 'merge-drop-turbo', title: 'Merge Drop Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Merge Drop: identical mechanics, 35% more speed, its own leaderboard. Drop fruit into a jar where everything rolls and settles properly. Two of the same fruit touching merge into the next size up, which can set off a chain all the way down the pile. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('meteor-miner', { id: 'meteor-miner-turbo', title: 'Meteor Miner Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Meteor Miner, but hurried. Asteroids with a day job. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('meteor-surf', { id: 'meteor-surf-turbo', title: 'Meteor Surf Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Meteor Surf: identical mechanics, 35% more speed, its own leaderboard. You are surfing a molten wave that never ends. Hold to dive: pressed into a downslope you gain huge speed, and carrying that speed over a crest launches you into the air — which is the only way past the obsidian spires. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('mini-golf', { id: 'mini-golf-turbo', title: 'Mini Golf Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Mini Golf: identical mechanics, 35% more speed, its own leaderboard. Drag back from the ball and let go — the length of the drag sets the power and a guide shows the line. Walls bounce the ball with a bit of energy lost each time, and sand traps kill your roll almost instantly. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('missile-defense', { id: 'missile-defense-turbo', title: 'Missile Defense Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Missile Defense. Click where you want your counter-missile to detonate — the fireball destroys anything that flies through it while it lasts, so the trick is to lead the incoming rather than aim at it. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('moto-hill', { id: 'moto-hill-turbo', title: 'Moto Hill Climb Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Moto Hill Climb, but hurried. A side-on physics bike over endless procedurally-generated hills that get taller the further you ride. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('night-rider', { id: 'night-rider-turbo', title: 'Night Rider Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Night Rider. Ride a neon motorbike up a four-lane night highway that never ends. Every car you skim past without touching pays a 50-point near-miss bonus, so the best line is always the scariest one. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('nim', { id: 'nim-turbo', title: 'Nim Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Nim, wound up: everything moves at 135% speed and the reaction windows shrink to match. Four rows of matches. On your turn take as many as you like, but all from one row. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Nim is worth something on the Turbo leaderboard.',
  ...
  V('nine-mens-morris', { id: 'nine-mens-morris-turbo', title: 'Nine Men’s Morris Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Nine Men’s Morris, wound up: everything moves at 135% speed and the reaction windows shrink to match. An ancient game in three phases. First you both place nine pieces on the board; then you slide them along the lines; and once you are down to three you may fly anywhere. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Nine Men’s Morris is worth something on the Turbo leaderboard.',
  ...
  V('ninja-slice', { id: 'ninja-slice-turbo', title: 'Ninja Slice Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Ninja Slice Turbo is Ninja Slice with game time running about a third faster. A swipe game about timing rather than speed. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Ninja Slice.',
  ...
  V('ostrich-knights', { id: 'ostrich-knights-hyper', title: 'Ostrich Knights Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Ostrich Knights, seventy percent faster, in a hotter palette. Your mount only climbs while you flap and it keeps every bit of momentum, so the whole game is managing height. Collide with a rival rider and the higher lance wins outright — Bounders pay 500, Hunters 750, Shadow Lords 1500. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('ostrich-knights', { id: 'ostrich-knights-turbo', title: 'Ostrich Knights Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Ostrich Knights. Your mount only climbs while you flap and it keeps every bit of momentum, so the whole game is managing height. Collide with a rival rider and the higher lance wins outright — Bounders pay 500, Hunters 750, Shadow Lords 1500. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('paint-wars', { id: 'paint-wars-turbo', title: 'Paint Wars Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Paint Wars: identical mechanics, 35% more speed, its own leaderboard. Skate around the arena leaving your colour on every tile while Rosa and Limey do the same. Ink is the whole game: it drains as you claim tiles (stealing painted ground costs extra), only refills while you ride your own colour, and enemy paint slows you down. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('pancake-pile', { id: 'pancake-pile-turbo', title: 'Pancake Pile Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Pancake Pile, but hurried. Pancakes fly in from alternating griddles and the plate has to be under each one. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('pancake-pile', { id: 'pancake-pile-zen', title: 'Pancake Pile Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Pancake Pile Zen slows Pancake Pile to about three-quarter speed and gives it a calmer palette. Pancakes fly in from alternating griddles and the plate has to be under each one. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('paper-claim', { id: 'paper-claim-turbo', title: 'Paper Claim Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Paper Claim: identical mechanics, 35% more speed, its own leaderboard. You start with a small square of territory. Drive outside it and you leave a trail behind you; get back to your own land and everything the loop enclosed becomes yours. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('paper-claim', { id: 'paper-claim-zen', title: 'Paper Claim Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Paper Claim. You start with a small square of territory. Drive outside it and you leave a trail behind you; get back to your own land and everything the loop enclosed becomes yours. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('paper-planes', { id: 'paper-planes-turbo', title: 'Paper Planes Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Paper Planes. Pull the dart back like a slingshot and let it go, then hold to dive when you need speed and let go to stretch the glide — height is the fuel you spend on distance. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('paper-planes', { id: 'paper-planes-zen', title: 'Paper Planes Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Paper Planes: identical rules, 28% slower, separate high score. Pull the dart back like a slingshot and let it go, then hold to dive when you need speed and let go to stretch the glide — height is the fuel you spend on distance. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('parking-draw', { id: 'parking-draw-turbo', title: 'Parking Draw Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Parking Draw: identical mechanics, 35% more speed, its own leaderboard. Every car needs a hand-drawn line from where it sits to the bay painted in its own colour, and a line that clips a concrete block is rejected on the spot. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('parking-draw', { id: 'parking-draw-zen', title: 'Parking Draw Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Parking Draw. Every car needs a hand-drawn line from where it sits to the bay painted in its own colour, and a line that clips a concrete block is rejected on the spot. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('peg-solitaire', { id: 'peg-solitaire-turbo', title: 'Peg Solitaire Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Peg Solitaire. The English cross board: 33 holes, 32 pegs and one gap in the middle. Jump a peg straight over a neighbour into an empty hole and the peg you jumped comes off. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('penalty-shootout', { id: 'penalty-shootout-turbo', title: 'Penalty Shootout Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Penalty Shootout. You alternate between taking penalties and keeping them out. Taking one, you drag to pick a spot in the goal; keeping, you commit to diving left, centre or right. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('perfect-circle', { id: 'perfect-circle-turbo', title: 'Perfect Circle Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Perfect Circle. One stroke, around the dot, no lifting. Your score multiplies how consistent your radius stayed by how much of the full turn you actually drew, so a beautiful three-quarter arc will not save you. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('star-gate', { id: 'star-gate-hyper', title: 'Star Gate Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Star Gate Hyper is Star Gate with the clock running 70% faster. A wrapping planet you patrol at speed, with a radar strip along the top showing the whole ridge at once. Purple landers descend, hook a scientist and haul them to the ceiling — if one makes it, the scientist returns as a mutant that hunts you down. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Star Gate record.',
  ...
  V('submarine-strike', { id: 'submarine-strike-zen', title: 'Submarine Strike Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Submarine Strike: identical rules, 28% slower, separate high score. Your torpedoes are buoyant: they rise as they run, so the killing shot is fired from below and ahead of a convoy ship, two torpedoes per hull. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('sudoku', { id: 'sudoku-zen', title: 'Sudoku Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Sudoku. Fill the grid so every row, column and 3×3 box contains 1 to 9 exactly once. Puzzles are generated from scratch and clues are only removed while exactly one solution remains, so nothing ever needs guessing. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('sweet-match', { id: 'sweet-match-zen', title: 'Sweet Match Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Sweet Match, tinted cool. A match-three where score is not the point: each level names one sweet and a number of them to clear, and gives you a fixed number of moves to do it. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('sword-storm', { id: 'sword-storm-zen', title: 'Sword Storm Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Sword Storm Zen slows Sword Storm to about three-quarter speed and gives it a calmer palette. A rhythm brawler: attackers rush your samurai from four sides in time with a metronome that climbs four bpm every eight beats. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('table-tennis', { id: 'table-tennis-zen', title: 'Table Tennis Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Table Tennis, tinted cool. A behind-the-paddle rally game, first to 11 against a robot that gets faster and more accurate every game you take off it. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('tangram-fit', { id: 'tangram-fit-hyper', title: 'Tangram Fit Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Tangram Fit, seventy percent faster, in a hotter palette. The classic Chinese dissection puzzle: two large triangles, one medium, two small, a square and a parallelogram, and a black silhouette they must fill exactly. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('tangram-fit', { id: 'tangram-fit-zen', title: 'Tangram Fit Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Tangram Fit: identical rules, 28% slower, separate high score. The classic Chinese dissection puzzle: two large triangles, one medium, two small, a square and a parallelogram, and a black silhouette they must fill exactly. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('tank-arena', { id: 'tank-arena-hyper', title: 'Tank Arena Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Tank Arena: same mechanics, 1.7× game speed, separate leaderboard. Drive a tank around a walled arena while hunting bots close in. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('tank-arena', { id: 'tank-arena-zen', title: 'Tank Arena Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Tank Arena Zen slows Tank Arena to about three-quarter speed and gives it a calmer palette. Drive a tank around a walled arena while hunting bots close in. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('terra-dig', { id: 'terra-dig-hyper', title: 'Terra Dig Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Terra Dig Hyper is Terra Dig with the clock running 70% faster. A side-on world you can tunnel straight through. Hold the left button to dig — harder rock takes longer — and everything you break goes into your inventory. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Terra Dig record.',
  ...
  V('tile-match', { id: 'tile-match-hyper', title: 'Tile Match Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Tile Match, seventy percent faster, in a hotter palette. Tiles are stacked three layers deep. Remove matching pairs — but only tiles that have nothing on top of them and at least one open side can be taken, so the order matters as much as spotting the match. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('tower-defence', { id: 'tower-defence-hyper', title: 'Tower Defence Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Tower Defence, seventy percent faster, in a hotter palette. Enemies follow a fixed path from one side to the other; you build towers on the ground beside it. Guns are cheap and fast, frost towers halve enemy speed, and cannons hit everything within a blast radius — the answer is usually a mix. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('tower-of-hanoi', { id: 'tower-of-hanoi-hyper', title: 'Tower of Hanoi Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Tower of Hanoi at 1.7× speed. Shift the whole tower from the left peg to the right one. You can only move a single disc at a time and a larger disc can never sit on a smaller one. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('tower-stack', { id: 'tower-stack-hyper', title: 'Tower Stack Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Tower Stack Hyper is Tower Stack with the clock running 70% faster. A block slides back and forth above your tower. Tap to drop it. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Tower Stack record.',
  ...
  V('tunnel-digger', { id: 'tunnel-digger-hyper', title: 'Tunnel Digger Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Tunnel Digger: same mechanics, 1.7× game speed, separate leaderboard. You chew tunnels through four bands of soil while red grubs and green fire-breathers hunt you down them. The pump harpoon reaches three tiles along a clear tunnel: latch on, then tap four times to pop — deeper kills pay more. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('tunnel-digger', { id: 'tunnel-digger-turbo', title: 'Tunnel Digger Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Tunnel Digger, but hurried. You chew tunnels through four bands of soil while red grubs and green fire-breathers hunt you down them. The pump harpoon reaches three tiles along a clear tunnel: latch on, then tap four times to pop — deeper kills pay more. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('tunnel-digger', { id: 'tunnel-digger-zen', title: 'Tunnel Digger Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Tunnel Digger Zen slows Tunnel Digger to about three-quarter speed and gives it a calmer palette. You chew tunnels through four bands of soil while red grubs and green fire-breathers hunt you down them. The pump harpoon reaches three tiles along a clear tunnel: latch on, then tap four times to pop — deeper kills pay more. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('tunnel-rush', { id: 'tunnel-rush-turbo', title: 'Tunnel Rush Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Tunnel Rush, but hurried. You are falling down a neon tunnel and every gate ahead is a solid ring with one gap in it. Steer around the tunnel wall to line up before the gate reaches you; hitting the ring dead centre scores a Perfect worth triple. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('tunnel-rush', { id: 'tunnel-rush-zen', title: 'Tunnel Rush Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Tunnel Rush Zen slows Tunnel Rush to about three-quarter speed and gives it a calmer palette. You are falling down a neon tunnel and every gate ahead is a solid ring with one gap in it. Steer around the tunnel wall to line up before the gate reaches you; hitting the ring dead centre scores a Perfect worth triple. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('turret-tower', { id: 'turret-tower-hyper', title: 'Turret Tower Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Turret Tower. You are a fixed turret in the middle of an open field, and rust-bots march in from every bearing — skimmers spiral, bombers hit the tower for three. Every shot heats the barrel: a hot gun sprays wide, and a maxed gauge locks you out while it vents. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('turret-tower', { id: 'turret-tower-turbo', title: 'Turret Tower Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Turret Tower, wound up: everything moves at 135% speed and the reaction windows shrink to match. You are a fixed turret in the middle of an open field, and rust-bots march in from every bearing — skimmers spiral, bombers hit the tower for three. Every shot heats the barrel: a hot gun sprays wide, and a maxed gauge locks you out while it vents. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Turret Tower is worth something on the Turbo leaderboard.',
  ...
  V('turret-tower', { id: 'turret-tower-zen', title: 'Turret Tower Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Turret Tower, tinted cool. You are a fixed turret in the middle of an open field, and rust-bots march in from every bearing — skimmers spiral, bombers hit the tower for three. Every shot heats the barrel: a hot gun sprays wide, and a maxed gauge locks you out while it vents. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('typing-test', { id: 'typing-test-hyper', title: 'Typing Test Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Typing Test, seventy percent faster, in a hotter palette. Sixty seconds of ordinary words. Type each one and press space; letters go green as you get them right and red as you get them wrong, so you can see a mistake before you commit it. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('typing-test', { id: 'typing-test-turbo', title: 'Typing Test Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Typing Test. Sixty seconds of ordinary words. Type each one and press space; letters go green as you get them right and red as you get them wrong, so you can see a mistake before you commit it. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('typing-test', { id: 'typing-test-zen', title: 'Typing Test Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Typing Test: identical rules, 28% slower, separate high score. Sixty seconds of ordinary words. Type each one and press space; letters go green as you get them right and red as you get them wrong, so you can see a mistake before you commit it. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('ultimate-ttt', { id: 'ultimate-ttt-hyper', title: 'Ultimate Tic Tac Toe Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Ultimate Tic Tac Toe at 1.7× speed. Nine small tic-tac-toe boards arranged in a big one. Win a small board and you claim that square; three claimed squares in a line wins overall. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('ultimate-ttt', { id: 'ultimate-ttt-turbo', title: 'Ultimate Tic Tac Toe Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Ultimate Tic Tac Toe Turbo is Ultimate Tic Tac Toe with game time running about a third faster. Nine small tic-tac-toe boards arranged in a big one. Win a small board and you claim that square; three claimed squares in a line wins overall. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Ultimate Tic Tac Toe.',
  ...
  V('ultimate-ttt', { id: 'ultimate-ttt-zen', title: 'Ultimate Tic Tac Toe Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Ultimate Tic Tac Toe at a gentler pace. Nine small tic-tac-toe boards arranged in a big one. Win a small board and you claim that square; three claimed squares in a line wins overall. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Ultimate Tic Tac Toe.',
  ...
  V('velodrome-dash', { id: 'velodrome-dash-hyper', title: 'Velodrome Dash Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Velodrome Dash Hyper is Velodrome Dash with the clock running 70% faster. A best-of-three match sprint on the boards: alternate ← and → to turn the pedals, and watch the tank — every stroke costs stamina and hitting zero blows your legs for a long coasting eternity. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Velodrome Dash record.',
  ...
  V('velodrome-dash', { id: 'velodrome-dash-turbo', title: 'Velodrome Dash Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Velodrome Dash: identical mechanics, 35% more speed, its own leaderboard. A best-of-three match sprint on the boards: alternate ← and → to turn the pedals, and watch the tank — every stroke costs stamina and hitting zero blows your legs for a long coasting eternity. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('velodrome-dash', { id: 'velodrome-dash-zen', title: 'Velodrome Dash Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Velodrome Dash. A best-of-three match sprint on the boards: alternate ← and → to turn the pedals, and watch the tank — every stroke costs stamina and hitting zero blows your legs for a long coasting eternity. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('vine-swing', { id: 'vine-swing-hyper', title: 'Vine Swing Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Vine Swing, seventy percent faster, in a hotter palette. One button: hold it and you grab the nearest vine, release it and you fly with whatever speed the swing gave you. Where you let go is everything — on the way up just before the top sends you far and high, at the very top drops you like a stone. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('vine-swing', { id: 'vine-swing-turbo', title: 'Vine Swing Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Vine Swing. One button: hold it and you grab the nearest vine, release it and you fly with whatever speed the swing gave you. Where you let go is everything — on the way up just before the top sends you far and high, at the very top drops you like a stone. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('vine-swing', { id: 'vine-swing-zen', title: 'Vine Swing Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Vine Swing: identical rules, 28% slower, separate high score. One button: hold it and you grab the nearest vine, release it and you fly with whatever speed the swing gave you. Where you let go is everything — on the way up just before the top sends you far and high, at the very top drops you like a stone. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('volcano-escape', { id: 'volcano-escape-hyper', title: 'Volcano Escape Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Volcano Escape: same mechanics, 1.7× game speed, separate leaderboard. A wall-kick climber. You cling to one side of a winding basalt shaft and every jump kicks you across to the other wall a little higher up; hang on too long and your grip drains until you slide, faster on the red-hot patches. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('volcano-escape', { id: 'volcano-escape-turbo', title: 'Volcano Escape Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Volcano Escape, but hurried. A wall-kick climber. You cling to one side of a winding basalt shaft and every jump kicks you across to the other wall a little higher up; hang on too long and your grip drains until you slide, faster on the red-hot patches. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('volcano-escape', { id: 'volcano-escape-zen', title: 'Volcano Escape Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Volcano Escape Zen slows Volcano Escape to about three-quarter speed and gives it a calmer palette. A wall-kick climber. You cling to one side of a winding basalt shaft and every jump kicks you across to the other wall a little higher up; hang on too long and your grip drains until you slide, faster on the red-hot patches. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('volleyball-blobs', { id: 'volleyball-blobs-hyper', title: 'Blob Volleyball Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Blob Volleyball, seventy percent faster, in a hotter palette. One-on-one volleyball between two wobbling blobs on an evening beach, first to 15. The ball inherits your blob’s motion, so the spike is all timing: rise into the ball at the net and it comes down steep on the far side. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('volleyball-blobs', { id: 'volleyball-blobs-turbo', title: 'Blob Volleyball Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Blob Volleyball. One-on-one volleyball between two wobbling blobs on an evening beach, first to 15. The ball inherits your blob’s motion, so the spike is all timing: rise into the ball at the net and it comes down steep on the far side. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('volleyball-blobs', { id: 'volleyball-blobs-zen', title: 'Blob Volleyball Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Blob Volleyball: identical rules, 28% slower, separate high score. One-on-one volleyball between two wobbling blobs on an evening beach, first to 15. The ball inherits your blob’s motion, so the spike is all timing: rise into the ball at the net and it comes down steep on the far side. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('wall-jumper', { id: 'wall-jumper-hyper', title: 'Wall Jumper Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Wall Jumper Hyper is Wall Jumper with the clock running 70% faster. Cling to a wall and you slide slowly down it; tap and you kick off in a flat arc to the opposite wall, gaining a little height with every crossing. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Wall Jumper record.',
  ...
  V('wall-jumper', { id: 'wall-jumper-turbo', title: 'Wall Jumper Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Wall Jumper: identical mechanics, 35% more speed, its own leaderboard. Cling to a wall and you slide slowly down it; tap and you kick off in a flat arc to the opposite wall, gaining a little height with every crossing. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('wall-jumper', { id: 'wall-jumper-zen', title: 'Wall Jumper Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Wall Jumper. Cling to a wall and you slide slowly down it; tap and you kick off in a flat arc to the opposite wall, gaining a little height with every crossing. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('war-cards', { id: 'war-cards-hyper', title: 'War Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'War Hyper is War with the clock running 70% faster. The simplest card game there is, and strangely hard to stop playing. The deck splits in two, you each flip one card, and the higher rank takes both. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your War record.',
  ...
  V('war-cards', { id: 'war-cards-turbo', title: 'War Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of War: identical mechanics, 35% more speed, its own leaderboard. The simplest card game there is, and strangely hard to stop playing. The deck splits in two, you each flip one card, and the higher rank takes both. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('war-cards', { id: 'war-cards-zen', title: 'War Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of War. The simplest card game there is, and strangely hard to stop playing. The deck splits in two, you each flip one card, and the higher rank takes both. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('water-sort', { id: 'water-sort-hyper', title: 'Water Sort Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Water Sort, seventy percent faster, in a hotter palette. Tubes of stacked coloured liquid, jumbled up. Pour from one to another to sort them — but liquid only pours onto the same colour or into an empty tube, and a whole run of matching colour moves at once. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('water-sort', { id: 'water-sort-turbo', title: 'Water Sort Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Water Sort. Tubes of stacked coloured liquid, jumbled up. Pour from one to another to sort them — but liquid only pours onto the same colour or into an empty tube, and a whole run of matching colour moves at once. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('water-sort', { id: 'water-sort-zen', title: 'Water Sort Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Water Sort: identical rules, 28% slower, separate high score. Tubes of stacked coloured liquid, jumbled up. Pour from one to another to sort them — but liquid only pours onto the same colour or into an empty tube, and a whole run of matching colour moves at once. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('whack-a-mole', { id: 'whack-a-mole-hyper', title: 'Whack-a-Mole Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Whack-a-Mole. Forty-five seconds of moles popping out of holes. Every brown mole you hit builds a combo worth more points, but the spiky green ones cost you 25 and reset the combo — as does swinging at nothing. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('whack-a-mole', { id: 'whack-a-mole-turbo', title: 'Whack-a-Mole Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Whack-a-Mole, wound up: everything moves at 135% speed and the reaction windows shrink to match. Forty-five seconds of moles popping out of holes. Every brown mole you hit builds a combo worth more points, but the spiky green ones cost you 25 and reset the combo — as does swinging at nothing. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Whack-a-Mole is worth something on the Turbo leaderboard.',
  ...
  V('whack-a-mole', { id: 'whack-a-mole-zen', title: 'Whack-a-Mole Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Whack-a-Mole, tinted cool. Forty-five seconds of moles popping out of holes. Every brown mole you hit builds a combo worth more points, but the spiky green ones cost you 25 and reset the combo — as does swinging at nothing. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('wind-glider', { id: 'wind-glider-hyper', title: 'Wind Glider Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Wind Glider, seventy percent faster, in a hotter palette. A hang-glider run down an endless desert canyon. Holding pulls the nose up and trades airspeed for height; releasing dives and trades it back — let the speed readout drop under 40 km/h and the wing stalls, nose-down, until you dive out of it. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('wind-glider', { id: 'wind-glider-turbo', title: 'Wind Glider Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Wind Glider. A hang-glider run down an endless desert canyon. Holding pulls the nose up and trades airspeed for height; releasing dives and trades it back — let the speed readout drop under 40 km/h and the wing stalls, nose-down, until you dive out of it. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('wind-glider', { id: 'wind-glider-zen', title: 'Wind Glider Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Wind Glider: identical rules, 28% slower, separate high score. A hang-glider run down an endless desert canyon. Holding pulls the nose up and trades airspeed for height; releasing dives and trades it back — let the speed readout drop under 40 km/h and the wing stalls, nose-down, until you dive out of it. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('word-grid', { id: 'word-grid-hyper', title: 'Word Grid Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Word Grid, seventy percent faster, in a hotter palette. A 4×4 tray of letter dice and three minutes on the clock. Drag through touching letters — diagonals count — to spell words, with no reusing a tile inside one word. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('word-grid', { id: 'word-grid-turbo', title: 'Word Grid Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Word Grid. A 4×4 tray of letter dice and three minutes on the clock. Drag through touching letters — diagonals count — to spell words, with no reusing a tile inside one word. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('word-grid', { id: 'word-grid-zen', title: 'Word Grid Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Word Grid: identical rules, 28% slower, separate high score. A 4×4 tray of letter dice and three minutes on the clock. Drag through touching letters — diagonals count — to spell words, with no reusing a tile inside one word. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('word-ladder', { id: 'word-ladder-hyper', title: 'Word Ladder Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Word Ladder. Climb from the starting word to the target by changing exactly one letter per step — and every rung has to be a real five-letter word. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('word-ladder', { id: 'word-ladder-turbo', title: 'Word Ladder Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Word Ladder, wound up: everything moves at 135% speed and the reaction windows shrink to match. Climb from the starting word to the target by changing exactly one letter per step — and every rung has to be a real five-letter word. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Word Ladder is worth something on the Turbo leaderboard.',
  ...
  V('word-ladder', { id: 'word-ladder-zen', title: 'Word Ladder Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Word Ladder, tinted cool. Climb from the starting word to the target by changing exactly one letter per step — and every rung has to be a real five-letter word. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('word-search', { id: 'word-search-hyper', title: 'Word Search Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Word Search at 1.7× speed. A 12×12 grid with nine words buried in it — horizontally, vertically or diagonally, and plenty of them written backwards. Drag from the first letter of a word to its last to claim it. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('word-search', { id: 'word-search-turbo', title: 'Word Search Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Word Search Turbo is Word Search with game time running about a third faster. A 12×12 grid with nine words buried in it — horizontally, vertically or diagonally, and plenty of them written backwards. Drag from the first letter of a word to its last to claim it. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Word Search.',
  ...
  V('word-search', { id: 'word-search-zen', title: 'Word Search Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Word Search at a gentler pace. A 12×12 grid with nine words buried in it — horizontally, vertically or diagonally, and plenty of them written backwards. Drag from the first letter of a word to its last to claim it. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Word Search.',
  ...
  V('wrecking-ball', { id: 'wrecking-ball-hyper', title: 'Wrecking Ball Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Wrecking Ball Hyper is Wrecking Ball with the clock running 70% faster. Hold to haul the crane ball back and release to send it swinging into the block towers. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Wrecking Ball record.',
  ...
  V('wrecking-ball', { id: 'wrecking-ball-turbo', title: 'Wrecking Ball Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Wrecking Ball: identical mechanics, 35% more speed, its own leaderboard. Hold to haul the crane ball back and release to send it swinging into the block towers. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('wrecking-ball', { id: 'wrecking-ball-zen', title: 'Wrecking Ball Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Wrecking Ball. Hold to haul the crane ball back and release to send it swinging into the block towers. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('ws-animals', { id: 'ws-animals-hyper', title: 'Word Search: Animals Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Word Search: Animals, seventy percent faster, in a hotter palette. Ten animals from a thirty-strong list hide in a 12×12 grid — across, down, diagonal, and often spelled backwards. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('ws-animals', { id: 'ws-animals-turbo', title: 'Word Search: Animals Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Word Search: Animals. Ten animals from a thirty-strong list hide in a 12×12 grid — across, down, diagonal, and often spelled backwards. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('ws-animals', { id: 'ws-animals-zen', title: 'Word Search: Animals Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Word Search: Animals: identical rules, 28% slower, separate high score. Ten animals from a thirty-strong list hide in a 12×12 grid — across, down, diagonal, and often spelled backwards. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('zig-zag', { id: 'zig-zag-hyper', title: 'Zig Zag Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Zig Zag at 1.7× speed. A ball rolls along a narrow zig-zagging path with nothing either side of it. Every tap switches your direction ninety degrees — the whole game is knowing exactly when. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('zig-zag', { id: 'zig-zag-turbo', title: 'Zig Zag Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Zig Zag Turbo is Zig Zag with game time running about a third faster. A ball rolls along a narrow zig-zagging path with nothing either side of it. Every tap switches your direction ninety degrees — the whole game is knowing exactly when. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Zig Zag.',
  ...
  V('zig-zag', { id: 'zig-zag-zen', title: 'Zig Zag Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zig Zag at a gentler pace. A ball rolls along a narrow zig-zagging path with nothing either side of it. Every tap switches your direction ninety degrees — the whole game is knowing exactly when. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Zig Zag.',
  ...
  V('zombie-siege', { id: 'zombie-siege-hyper', title: 'Zombie Siege Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Zombie Siege, seventy percent faster, in a hotter palette. Zombies pour in from every edge, and half of them ignore you completely to chew through the farmhouse windows. Kill for ammo drops, then spend the short break between waves standing next to broken windows to hammer boards back on. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('zombie-siege', { id: 'zombie-siege-turbo', title: 'Zombie Siege Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Zombie Siege. Zombies pour in from every edge, and half of them ignore you completely to chew through the farmhouse windows. Kill for ammo drops, then spend the short break between waves standing next to broken windows to hammer boards back on. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('zombie-siege', { id: 'zombie-siege-zen', title: 'Zombie Siege Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Zombie Siege: identical rules, 28% slower, separate high score. Zombies pour in from every edge, and half of them ignore you completely to chew through the farmhouse windows. Kill for ammo drops, then spend the short break between waves standing next to broken windows to hammer boards back on. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
