/* ==========================================================================
   ...
   Generated by tools/build-variants.mjs; 605 remixes.
   ========================================================================== */
(function () {
  'use strict';
  ...
  V('bubble-shooter', { id: 'bubble-shooter-insane', title: 'Bubble Shooter: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    tagline: 'Bank it off the wall, drop the whole cluster at double speed',
    description: 'Bubble Shooter, twice as fast. The classic: aim the cannon, bounce shots off the side walls into gaps you cannot reach straight on, and land three matching bubbles to pop them. Insane is the top of the remix ladder: past this there is nothing, so a personal best here is the one to brag about. Scores are kept apart from the original and the other remixes.',
    colors: ['#08062a', '#ff73e3'], tags: ['bubble', 'match 3', 'aiming', 'insane', 'remix'] });
  ...
  V('bubble-shooter', { id: 'bubble-shooter-turbo', title: 'Bubble Shooter Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Bubble Shooter: identical mechanics, 35% more speed, its own leaderboard. The classic: aim the cannon, bounce shots off the side walls into gaps you cannot reach straight on, and land three matching bubbles to pop them. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('bubble-shooter', { id: 'bubble-shooter-zen', title: 'Bubble Shooter Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Bubble Shooter, tinted cool. The classic: aim the cannon, bounce shots off the side walls into gaps you cannot reach straight on, and land three matching bubbles to pop them. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('bubble-trap', { id: 'bubble-trap-insane', title: 'Bubble Trap: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Bubble Trap: identical mechanics, game time × 2, warm palette, separate best score. Blow a bubble and it shoots forward for half a second, trapping any critter it touches before it starts to float. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
  ...
  V('bubble-trap', { id: 'bubble-trap-turbo', title: 'Bubble Trap Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Bubble Trap, but hurried. Blow a bubble and it shoots forward for half a second, trapping any critter it touches before it starts to float. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('bubble-trap', { id: 'bubble-trap-zen', title: 'Bubble Trap Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Bubble Trap at a gentler pace. Blow a bubble and it shoots forward for half a second, trapping any critter it touches before it starts to float. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Bubble Trap.',
  ...
  V('bug-blaster', { id: 'bug-blaster-insane', title: 'Bug Blaster: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Bug Blaster: Insane Mode runs Bug Blaster at exactly double speed. A centipede snakes down the screen, turning and dropping a row every time it meets a mushroom. Shooting a middle segment splits the body into two independent halves and leaves a new mushroom where it died — so careless shooting makes the board worse. Everything the original does, it does twice as fast — including the difficulty ramp — so this is less a game to beat than a game to survive, and a run that lasts thirty seconds is genuinely good. Own best score, warm palette.',
  ...
  V('bug-blaster', { id: 'bug-blaster-turbo', title: 'Bug Blaster Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Bug Blaster Turbo is Bug Blaster with game time running about a third faster. A centipede snakes down the screen, turning and dropping a row every time it meets a mushroom. Shooting a middle segment splits the body into two independent halves and leaves a new mushroom where it died — so careless shooting makes the board worse. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Bug Blaster.',
  ...
  V('bug-blaster', { id: 'bug-blaster-zen', title: 'Bug Blaster Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Bug Blaster: identical rules, 28% slower, separate high score. A centipede snakes down the screen, turning and dropping a row every time it meets a mushroom. Shooting a middle segment splits the body into two independent halves and leaves a new mushroom where it died — so careless shooting makes the board worse. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('burrow-blast', { id: 'burrow-blast-insane', title: 'Burrow Blast: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Burrow Blast: identical mechanics, game time × 2, warm palette, separate best score. You are a digger with an air pump and a whole hillside to tunnel through. Every tunnel you carve is one the crawlers can chase you down, so shaping the ground is half the fight. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
  ...
  V('burrow-blast', { id: 'burrow-blast-turbo', title: 'Burrow Blast Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Burrow Blast, but hurried. You are a digger with an air pump and a whole hillside to tunnel through. Every tunnel you carve is one the crawlers can chase you down, so shaping the ground is half the fight. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('burrow-blast', { id: 'burrow-blast-zen', title: 'Burrow Blast Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Burrow Blast at a gentler pace. You are a digger with an air pump and a whole hillside to tunnel through. Every tunnel you carve is one the crawlers can chase you down, so shaping the ground is half the fight. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Burrow Blast.',
  ...
  V('cannon-golf', { id: 'cannon-golf-insane', title: 'Cannon Golf: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Cannon Golf, twice as fast. Twelve cave holes played with a cannon that trundles along to wherever your ball stops. Drag from anywhere to set angle and power, watch the dotted preview bounce off the first wall, and fire. Insane is the top of the remix ladder: past this there is nothing, so a personal best here is the one to brag about. Scores are kept apart from the original and the other remixes.',
  ...
  V('cannon-golf', { id: 'cannon-golf-turbo', title: 'Cannon Golf Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Cannon Golf: identical mechanics, 35% more speed, its own leaderboard. Twelve cave holes played with a cannon that trundles along to wherever your ball stops. Drag from anywhere to set angle and power, watch the dotted preview bounce off the first wall, and fire. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('cannon-golf', { id: 'cannon-golf-zen', title: 'Cannon Golf Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Cannon Golf, tinted cool. Twelve cave holes played with a cannon that trundles along to wherever your ball stops. Drag from anywhere to set angle and power, watch the dotted preview bounce off the first wall, and fire. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('cannon-siege', { id: 'cannon-siege-insane', title: 'Cannon Siege: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'The double-speed edition of Cannon Siege. You and an enemy gun trade shots across broken ground. Set the angle and power of each shell and account for a crosswind that changes every round. Insane keeps every rule intact and simply halves the time you get for each decision; it is brutally short, oddly relaxing once you accept that, and tracked on its own high-score table.',
  ...
  V('cannon-siege', { id: 'cannon-siege-turbo', title: 'Cannon Siege Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Cannon Siege. You and an enemy gun trade shots across broken ground. Set the angle and power of each shell and account for a crosswind that changes every round. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('cannon-siege', { id: 'cannon-siege-zen', title: 'Cannon Siege Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Cannon Siege. You and an enemy gun trade shots across broken ground. Set the angle and power of each shell and account for a crosswind that changes every round. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('castle-raid', { id: 'castle-raid-insane', title: 'Castle Raid: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Castle Raid: identical mechanics, game time × 2, warm palette, separate best score. A side-view raid built on timing. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
  ...
  V('castle-raid', { id: 'castle-raid-turbo', title: 'Castle Raid Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Castle Raid, but hurried. A side-view raid built on timing. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('castle-raid', { id: 'castle-raid-zen', title: 'Castle Raid Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Castle Raid at a gentler pace. A side-view raid built on timing. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Castle Raid.',
  ...
  V('cave-flyer', { id: 'cave-flyer-turbo', title: 'Cave Flyer Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Cave Flyer: identical mechanics, 35% more speed, its own leaderboard. One control: hold to fire the thruster and climb, let go and gravity takes over. The cave winds unpredictably and — crucially — the gap keeps narrowing the further you fly, so a passage that felt generous at the start will not stay that way. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('cave-flyer', { id: 'cave-flyer-zen', title: 'Cave Flyer Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Cave Flyer, tinted cool. One control: hold to fire the thruster and climb, let go and gravity takes over. The cave winds unpredictably and — crucially — the gap keeps narrowing the further you fly, so a passage that felt generous at the start will not stay that way. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('centipede-strike', { id: 'centipede-strike-insane', title: 'Centipede Strike: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    tagline: 'Split the crawler before it reaches your band at double speed',
    description: 'The double-speed edition of Centipede Strike. A twelve-segment crawler winds down a field of teal spores, turning and dropping a row every time something blocks it. Insane keeps every rule intact and simply halves the time you get for each decision; it is brutally short, oddly relaxing once you accept that, and tracked on its own high-score table.',
    colors: ['#011513', '#ff4d62'], tags: ['classic', 'shooter', 'arcade', 'insane', 'remix'] });
  ...
  V('centipede-strike', { id: 'centipede-strike-turbo', title: 'Centipede Strike Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Centipede Strike. A twelve-segment crawler winds down a field of teal spores, turning and dropping a row every time something blocks it. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('centipede-strike', { id: 'centipede-strike-zen', title: 'Centipede Strike Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Centipede Strike. A twelve-segment crawler winds down a field of teal spores, turning and dropping a row every time something blocks it. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('checkers', { id: 'checkers-turbo', title: 'Checkers Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Checkers, wound up: everything moves at 135% speed and the reaction windows shrink to match. Move diagonally forward one square, or jump an opposing piece to take it. Captures are compulsory and chain, so a single move can clear three pieces off the board. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Checkers is worth something on the Turbo leaderboard.',
  ...
  V('checkers', { id: 'checkers-zen', title: 'Checkers Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Checkers Zen slows Checkers to about three-quarter speed and gives it a calmer palette. Move diagonally forward one square, or jump an opposing piece to take it. Captures are compulsory and chain, so a single move can clear three pieces off the board. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('chess-blitz', { id: 'chess-blitz-turbo', title: 'Chess Blitz Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Chess Blitz, wound up: everything moves at 135% speed and the reaction windows shrink to match. Full piece movement with check, checkmate and stalemate detection, and pawns that promote to queens. Legal moves are shown as dots when you pick up a piece — red rings mark captures. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Chess Blitz is worth something on the Turbo leaderboard.',
  ...
  V('chess-blitz', { id: 'chess-blitz-zen', title: 'Chess Blitz Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Chess Blitz Zen slows Chess Blitz to about three-quarter speed and gives it a calmer palette. Full piece movement with check, checkmate and stalemate detection, and pawns that promote to queens. Legal moves are shown as dots when you pick up a piece — red rings mark captures. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('city-idle', { id: 'city-idle-turbo', title: 'City Idle Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same City Idle, wound up: everything moves at 135% speed and the reaction windows shrink to match. A small city on a small grid, where nothing works unless it touches a road. Housing brings residents, shops and factories give them jobs, and a power plant keeps the whole thing lit — run short of any of the three and happiness starts sliding. Nothing about the rules changes — only how long you get to respond. A score that felt routine in City Idle is worth something on the Turbo leaderboard.',
  ...
  V('city-idle', { id: 'city-idle-zen', title: 'City Idle Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'City Idle Zen slows City Idle to about three-quarter speed and gives it a calmer palette. A small city on a small grid, where nothing works unless it touches a road. Housing brings residents, shops and factories give them jobs, and a power plant keeps the whole thing lit — run short of any of the three and happiness starts sliding. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('color-flood', { id: 'color-flood-hyper', title: 'Color Flood Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Color Flood. Your blob starts as the single top-left cell. Each colour you pick repaints the blob and absorbs every touching cell already wearing that colour, so the trick is picking the shade that opens the biggest corridor rather than the one that grabs most now. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
    colors: ['#082723', '#11ff31'], tags: ['flood fill', 'puzzle', 'colours', 'hyper', 'remix'] });

  V('color-flood', { id: 'color-flood-insane', title: 'Color Flood: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    tagline: 'Swallow the board one colour at a time at double speed',
    description: 'Color Flood: Insane Mode runs Color Flood at exactly double speed. Your blob starts as the single top-left cell. Each colour you pick repaints the blob and absorbs every touching cell already wearing that colour, so the trick is picking the shade that opens the biggest corridor rather than the one that grabs most now. Everything the original does, it does twice as fast — including the difficulty ramp — so this is less a game to beat than a game to survive, and a run that lasts thirty seconds is genuinely good. Own best score, warm palette.',
    colors: ['#0e0728', '#1190ff'], tags: ['flood fill', 'puzzle', 'colours', 'insane', 'remix'] });
  ...
  V('color-flood', { id: 'color-flood-turbo', title: 'Color Flood Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Color Flood Turbo is Color Flood with game time running about a third faster. Your blob starts as the single top-left cell. Each colour you pick repaints the blob and absorbs every touching cell already wearing that colour, so the trick is picking the shade that opens the biggest corridor rather than the one that grabs most now. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Color Flood.',
  ...
  V('color-rush', { id: 'color-rush-turbo', title: 'Colour Rush Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Colour Rush, wound up: everything moves at 135% speed and the reaction windows shrink to match. Rings made of four coloured quarters spin toward you. Swap your ball to the colour of the quarter you are about to pass through — get it wrong and you burst. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Colour Rush is worth something on the Turbo leaderboard.',
  ...
  V('crazy-eights', { id: 'crazy-eights-turbo', title: 'Crazy Eights Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Crazy Eights Turbo is Crazy Eights with game time running about a third faster. Play a card that matches either the suit or the rank of the top card. Eights are wild: play one and name whatever suit you like. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Crazy Eights.',
  ...
  V('crystal-caverns', { id: 'crystal-caverns-turbo', title: 'Crystal Caverns Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Crystal Caverns Turbo is Crystal Caverns with game time running about a third faster. Each cave is one screen: grab every glowing crystal and the exit arch lights up green. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Crystal Caverns.',
  ...
  V('cube-hopper', { id: 'cube-hopper-hyper', title: 'Cube Hopper Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Cube Hopper Hyper is Cube Hopper with the clock running 70% faster. Twenty-eight cubes make a seven-row pyramid and you hop diagonally across it until every top face has turned the target colour. Rounds three and four need two hops per cube; from round five a third hop turns one back, so route planning matters more than speed. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Cube Hopper record.',
  ...
  V('cube-hopper', { id: 'cube-hopper-turbo', title: 'Cube Hopper Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Cube Hopper, but hurried. Twenty-eight cubes make a seven-row pyramid and you hop diagonally across it until every top face has turned the target colour. Rounds three and four need two hops per cube; from round five a third hop turns one back, so route planning matters more than speed. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('domino-run', { id: 'domino-run-hyper', title: 'Domino Run Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Domino Run Hyper is Domino Run with the clock running 70% faster. Each level gives you a push arrow, a bell, and a handful of pieces. Dominoes topple the next one if it is within about a domino-length; stairs carry the chain down a ledge; springs bounce a rolling steel ball up to a higher platform. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Domino Run record.',
  ...
  V('dot-connect', { id: 'dot-connect-hyper', title: 'Dot Connect Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Dot Connect, seventy percent faster, in a hotter palette. Every colour appears twice; drag a path from one dot to its partner. Paths cannot cross, so routing one carelessly blocks the next — and drawing over an existing line simply erases it, which makes the real puzzle finding the order to connect them in. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('dots-and-boxes', { id: 'dots-and-boxes-hyper', title: 'Dots & Boxes Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Dots & Boxes, seventy percent faster, in a hotter palette. Take turns drawing a single line between two adjacent dots. Whoever draws the fourth side of a box claims it and immediately goes again, so a well-timed sacrifice can hand you a whole chain. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('flap-rocket', { id: 'flap-rocket-hyper', title: 'Flap Rocket Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Flap Rocket: same mechanics, 1.7× game speed, separate leaderboard. Tap, click or press Space to fire the thruster. Gravity does the rest. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('fling-fortress', { id: 'fling-fortress-hyper', title: 'Fling Fortress Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Fling Fortress: same mechanics, 1.7× game speed, separate leaderboard. Haul the sling back, line up the dotted arc and let fly. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('flip-bottle', { id: 'flip-bottle-hyper', title: 'Flip Bottle Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Flip Bottle, seventy percent faster, in a hotter palette. A meter sweeps back and forth and one tap throws the bottle at whatever power it was showing. Land in the green band and the bottle comes down flat on its base; nick the gold sliver dead centre and it balances on its cap for triple points. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('flip-bottle', { id: 'flip-bottle-turbo', title: 'Flip Bottle Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Flip Bottle, wound up: everything moves at 135% speed and the reaction windows shrink to match. A meter sweeps back and forth and one tap throws the bottle at whatever power it was showing. Land in the green band and the bottle comes down flat on its base; nick the gold sliver dead centre and it balances on its cap for triple points. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Flip Bottle is worth something on the Turbo leaderboard.',
  ...
  V('flip-bottle', { id: 'flip-bottle-zen', title: 'Flip Bottle Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Flip Bottle Zen slows Flip Bottle to about three-quarter speed and gives it a calmer palette. A meter sweeps back and forth and one tap throws the bottle at whatever power it was showing. Land in the green band and the bottle comes down flat on its base; nick the gold sliver dead centre and it balances on its cap for triple points. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('kitchen-climb', { id: 'kitchen-climb-hyper', title: 'Kitchen Climb Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Kitchen Climb at 1.7× speed. Four burgers are scattered in pieces across five kitchen floors. Walking the full width of a layer knocks it to the floor below, and a layer landing on another sends both onward — a four-floor chain is worth many times four single drops. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('kitchen-climb', { id: 'kitchen-climb-turbo', title: 'Kitchen Climb Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Kitchen Climb: identical mechanics, 35% more speed, its own leaderboard. Four burgers are scattered in pieces across five kitchen floors. Walking the full width of a layer knocks it to the floor below, and a layer landing on another sends both onward — a four-floor chain is worth many times four single drops. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('kitchen-climb', { id: 'kitchen-climb-zen', title: 'Kitchen Climb Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Kitchen Climb, tinted cool. Four burgers are scattered in pieces across five kitchen floors. Walking the full width of a layer knocks it to the floor below, and a layer landing on another sends both onward — a four-floor chain is worth many times four single drops. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('klondike', { id: 'klondike-hyper', title: 'Klondike Solitaire Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Klondike Solitaire, seventy percent faster, in a hotter palette. Build all four foundations from Ace up to King. The tableau stacks downwards in alternating colours, only a King can start an empty column, and the stock recycles when you run out. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('klondike', { id: 'klondike-turbo', title: 'Klondike Solitaire Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Klondike Solitaire, wound up: everything moves at 135% speed and the reaction windows shrink to match. Build all four foundations from Ace up to King. The tableau stacks downwards in alternating colours, only a King can start an empty column, and the stock recycles when you run out. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Klondike Solitaire is worth something on the Turbo leaderboard.',
  ...
  V('klondike', { id: 'klondike-zen', title: 'Klondike Solitaire Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Klondike Solitaire Zen slows Klondike Solitaire to about three-quarter speed and gives it a calmer palette. Build all four foundations from Ace up to King. The tableau stacks downwards in alternating colours, only a King can start an empty column, and the stock recycles when you run out. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('knife-throw', { id: 'knife-throw-hyper', title: 'Knife Throw Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Knife Throw, seventy percent faster, in a hotter palette. Throw knives into a rotating log without hitting one already stuck in it. Every stage adds knives to throw, speeds the spin up and leaves more grey blades in the way — and past stage four the log starts changing speed as it turns. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('knife-throw', { id: 'knife-throw-turbo', title: 'Knife Throw Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Knife Throw, wound up: everything moves at 135% speed and the reaction windows shrink to match. Throw knives into a rotating log without hitting one already stuck in it. Every stage adds knives to throw, speeds the spin up and leaves more grey blades in the way — and past stage four the log starts changing speed as it turns. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Knife Throw is worth something on the Turbo leaderboard.',
  ...
  V('knife-throw', { id: 'knife-throw-zen', title: 'Knife Throw Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Knife Throw Zen slows Knife Throw to about three-quarter speed and gives it a calmer palette. Throw knives into a rotating log without hitting one already stuck in it. Every stage adds knives to throw, speeds the spin up and leaves more grey blades in the way — and past stage four the log starts changing speed as it turns. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('laser-dodge', { id: 'laser-dodge-hyper', title: 'Laser Dodge Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Laser Dodge Hyper is Laser Dodge with the clock running 70% faster. A single room that keeps filling with light. Every beam warns you first with a thin dotted line, so the whole game is reading the next second and being somewhere else when it arrives. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Laser Dodge record.',
  ...
  V('laser-dodge', { id: 'laser-dodge-turbo', title: 'Laser Dodge Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Laser Dodge, but hurried. A single room that keeps filling with light. Every beam warns you first with a thin dotted line, so the whole game is reading the next second and being somewhere else when it arrives. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('laser-dodge', { id: 'laser-dodge-zen', title: 'Laser Dodge Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Laser Dodge at a gentler pace. A single room that keeps filling with light. Every beam warns you first with a thin dotted line, so the whole game is reading the next second and being somewhere else when it arrives. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Laser Dodge.',
  ...
  V('laser-duel', { id: 'laser-duel-hyper', title: 'Laser Duel Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Laser Duel at 1.7× speed. A one-hit duel against an AI gunslinger, best of five rounds. Every bolt survives two wall bounces, so the strongest play is the shot your opponent never sees coming — banked off a wall or around a pillar, worth 150 instead of 100. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('laser-duel', { id: 'laser-duel-turbo', title: 'Laser Duel Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Laser Duel: identical mechanics, 35% more speed, its own leaderboard. A one-hit duel against an AI gunslinger, best of five rounds. Every bolt survives two wall bounces, so the strongest play is the shot your opponent never sees coming — banked off a wall or around a pillar, worth 150 instead of 100. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('laser-duel', { id: 'laser-duel-zen', title: 'Laser Duel Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Laser Duel, tinted cool. A one-hit duel against an AI gunslinger, best of five rounds. Every bolt survives two wall bounces, so the strongest play is the shot your opponent never sees coming — banked off a wall or around a pillar, worth 150 instead of 100. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('laser-maze', { id: 'laser-maze-turbo', title: 'Laser Maze Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Laser Maze, wound up: everything moves at 135% speed and the reaction windows shrink to match. A beam fires from the left and you steer it by flipping mirrors between their two diagonal orientations. The beam updates live as you click, so you can see exactly where it goes wrong. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Laser Maze is worth something on the Turbo leaderboard.',
  ...
  V('laser-maze', { id: 'laser-maze-zen', title: 'Laser Maze Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Laser Maze Zen slows Laser Maze to about three-quarter speed and gives it a calmer palette. A beam fires from the left and you steer it by flipping mirrors between their two diagonal orientations. The beam updates live as you click, so you can see exactly where it goes wrong. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('lava-run', { id: 'lava-run-turbo', title: 'Lava Run Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Lava Run, wound up: everything moves at 135% speed and the reaction windows shrink to match. A vertical scramble with a rising tide of lava underneath that gets faster the higher you climb. Brown ledges are solid, blue ones slide sideways, orange ones crumble the moment you leave them, and green ones fling you well above a normal jump. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Lava Run is worth something on the Turbo leaderboard.',
  ...
  V('lava-run', { id: 'lava-run-zen', title: 'Lava Run Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Lava Run Zen slows Lava Run to about three-quarter speed and gives it a calmer palette. A vertical scramble with a rising tide of lava underneath that gets faster the higher you climb. Brown ledges are solid, blue ones slide sideways, orange ones crumble the moment you leave them, and green ones fling you well above a normal jump. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('letter-drop', { id: 'letter-drop-turbo', title: 'Letter Drop Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Letter Drop, wound up: everything moves at 135% speed and the reaction windows shrink to match. New rows of letters push up from the bottom on a timer that keeps getting shorter. Click a chain of touching letters — any direction, including diagonals — to spell a word, then press Enter to clear them and drop everything above down. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Letter Drop is worth something on the Turbo leaderboard.',
  ...
  V('letter-drop', { id: 'letter-drop-zen', title: 'Letter Drop Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Letter Drop Zen slows Letter Drop to about three-quarter speed and gives it a calmer palette. New rows of letters push up from the bottom on a timer that keeps getting shorter. Click a chain of touching letters — any direction, including diagonals — to spell a word, then press Enter to clear them and drop everything above down. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('lunar-lander', { id: 'lunar-lander-turbo', title: 'Lunar Lander Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Lunar Lander: identical mechanics, 35% more speed, its own leaderboard. Gravity is constant and your thruster burns fuel you cannot replace. To land you need all three at once: on a flat pad, close to upright, and slow — the descent and drift readouts turn green when each is safe. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('lunar-lander', { id: 'lunar-lander-zen', title: 'Lunar Lander Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Lunar Lander, tinted cool. Gravity is constant and your thruster burns fuel you cannot replace. To land you need all three at once: on a flat pad, close to upright, and slow — the descent and drift readouts turn green when each is safe. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('magnet-boots', { id: 'magnet-boots-turbo', title: 'Magnet Boots Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Magnet Boots, wound up: everything moves at 135% speed and the reaction windows shrink to match. There is no jump. Your boots cling to metal plates, and pressing flip while they are touching one reverses the pull so you fall to the opposite surface — cross a floor full of live wires by walking the ceiling over it. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Magnet Boots is worth something on the Turbo leaderboard.',
  ...
  V('magnet-boots', { id: 'magnet-boots-zen', title: 'Magnet Boots Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Magnet Boots Zen slows Magnet Boots to about three-quarter speed and gives it a calmer palette. There is no jump. Your boots cling to metal plates, and pressing flip while they are touching one reverses the pull so you fall to the opposite surface — cross a floor full of live wires by walking the ceiling over it. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('make-24', { id: 'make-24-turbo', title: 'Make 24 Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Make 24, but hurried. Combine all four numbers — each used exactly once — with addition, subtraction, multiplication and division to land on exactly 24. Fractions along the way are fine. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('make-24', { id: 'make-24-zen', title: 'Make 24 Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Make 24 at a gentler pace. Combine all four numbers — each used exactly once — with addition, subtraction, multiplication and division to land on exactly 24. Fractions along the way are fine. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Make 24.',
  ...
  V('mancala', { id: 'mancala-turbo', title: 'Mancala Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Mancala Turbo is Mancala with game time running about a third faster. One of the oldest board games there is. Lift all the seeds from one of your pits and drop them one per pit going anticlockwise, skipping the opponent’s store. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Mancala.',
  ...
  V('mancala', { id: 'mancala-zen', title: 'Mancala Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Mancala: identical rules, 28% slower, separate high score. One of the oldest board games there is. Lift all the seeds from one of your pits and drop them one per pit going anticlockwise, skipping the opponent’s store. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('mastermind', { id: 'mastermind-turbo', title: 'Mastermind Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Mastermind Turbo is Mastermind with game time running about a third faster. A hidden sequence of four colours drawn from six, repeats allowed. Each guess comes back with pegs: a dark peg for a colour that is right and in the right place, a white peg for a colour that is right but misplaced. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Mastermind.',
  ...
  V('math-blitz', { id: 'math-blitz-turbo', title: 'Math Blitz Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Math Blitz. Answer as many sums as you can in a minute. Every correct answer adds a second back to the clock and grows your streak multiplier; every wrong one takes two away. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('math-blitz', { id: 'math-blitz-zen', title: 'Math Blitz Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Math Blitz. Answer as many sums as you can in a minute. Every correct answer adds a second back to the clock and grows your streak multiplier; every wrong one takes two away. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('maze-muncher', { id: 'maze-muncher-turbo', title: 'Maze Muncher Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Maze Muncher, wound up: everything moves at 135% speed and the reaction windows shrink to match. Clear every dot in the maze while three ghosts hunt you down. The four big pellets in the corners turn them blue for seven seconds — catch one then and it is worth 200 points and a trip back to its box. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Maze Muncher is worth something on the Turbo leaderboard.',
  ...
  V('maze-muncher', { id: 'maze-muncher-zen', title: 'Maze Muncher Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Maze Muncher Zen slows Maze Muncher to about three-quarter speed and gives it a calmer palette. Clear every dot in the maze while three ghosts hunt you down. The four big pellets in the corners turn them blue for seven seconds — catch one then and it is worth 200 points and a trip back to its box. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('maze-runner', { id: 'maze-runner-turbo', title: 'Maze Runner Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Maze Runner. Start top-left, reach the green exit bottom-right. Each maze is generated fresh, and your lantern lights only the corridors near you — so you are mapping it as you go. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('maze-runner', { id: 'maze-runner-zen', title: 'Maze Runner Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Maze Runner. Start top-left, reach the green exit bottom-right. Each maze is generated fresh, and your lantern lights only the corridors near you — so you are mapping it as you go. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('mech-storm', { id: 'mech-storm-turbo', title: 'Mech Storm Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Mech Storm, but hurried. Your mech marches itself down the canyon — you work the jump jets and the arm cannon. Drone squadrons dive from the right while dug-in turrets lob arcing shells you have to jet over. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('mech-storm', { id: 'mech-storm-zen', title: 'Mech Storm Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Mech Storm at a gentler pace. Your mech marches itself down the canyon — you work the jump jets and the arm cannon. Drone squadrons dive from the right while dug-in turrets lob arcing shells you have to jet over. Zen is the same game with the clock dialled down — a way to enjoy the mechanics without the pressure, and the best place to work out strategies you can then take back to the original. Scores are kept apart from Mech Storm.',
  ...
  V('memory-sequence', { id: 'memory-sequence-turbo', title: 'Memory Sequence Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Memory Sequence Turbo is Memory Sequence with game time running about a third faster. A 4×4 grid flashes a sequence of squares and you tap them back in order. Each round adds one more step, and longer sequences flash faster — which is what actually breaks people, rather than the length itself. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Memory Sequence.',
  ...
  V('memory-sequence', { id: 'memory-sequence-zen', title: 'Memory Sequence Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Memory Sequence: identical rules, 28% slower, separate high score. A 4×4 grid flashes a sequence of squares and you tap them back in order. Each round adds one more step, and longer sequences flash faster — which is what actually breaks people, rather than the length itself. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('merge-drop', { id: 'merge-drop-turbo', title: 'Merge Drop Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Merge Drop. Drop fruit into a jar where everything rolls and settles properly. Two of the same fruit touching merge into the next size up, which can set off a chain all the way down the pile. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('merge-drop', { id: 'merge-drop-zen', title: 'Merge Drop Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Merge Drop. Drop fruit into a jar where everything rolls and settles properly. Two of the same fruit touching merge into the next size up, which can set off a chain all the way down the pile. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('meteor-miner', { id: 'meteor-miner-turbo', title: 'Meteor Miner Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Meteor Miner, wound up: everything moves at 135% speed and the reaction windows shrink to match. Asteroids with a day job. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Meteor Miner is worth something on the Turbo leaderboard.',
  ...
  V('meteor-miner', { id: 'meteor-miner-zen', title: 'Meteor Miner Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Meteor Miner Zen slows Meteor Miner to about three-quarter speed and gives it a calmer palette. Asteroids with a day job. With more time between decisions it becomes a game about planning rather than twitch — good for learning the patterns, or for playing one-handed with a coffee. Zen has its own best score.',
  ...
  V('meteor-surf', { id: 'meteor-surf-turbo', title: 'Meteor Surf Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Meteor Surf. You are surfing a molten wave that never ends. Hold to dive: pressed into a downslope you gain huge speed, and carrying that speed over a crest launches you into the air — which is the only way past the obsidian spires. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('meteor-surf', { id: 'meteor-surf-zen', title: 'Meteor Surf Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Meteor Surf. You are surfing a molten wave that never ends. Hold to dive: pressed into a downslope you gain huge speed, and carrying that speed over a crest launches you into the air — which is the only way past the obsidian spires. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('mini-golf', { id: 'mini-golf-turbo', title: 'Mini Golf Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Mini Golf. Drag back from the ball and let go — the length of the drag sets the power and a guide shows the line. Walls bounce the ball with a bit of energy lost each time, and sand traps kill your roll almost instantly. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('mini-golf', { id: 'mini-golf-zen', title: 'Mini Golf Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'The relaxed version of Mini Golf. Drag back from the ball and let go — the length of the drag sets the power and a guide shows the line. Walls bounce the ball with a bit of energy lost each time, and sand traps kill your roll almost instantly. Game time runs at 72% of normal, so everything that felt urgent in the original becomes readable, and long runs are about consistency rather than reflexes. Separate leaderboard, same controls.',
  ...
  V('missile-defense', { id: 'missile-defense-turbo', title: 'Missile Defense Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Missile Defense Turbo is Missile Defense with game time running about a third faster. Click where you want your counter-missile to detonate — the fireball destroys anything that flies through it while it lasts, so the trick is to lead the incoming rather than aim at it. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Missile Defense.',
  ...
  V('missile-defense', { id: 'missile-defense-zen', title: 'Missile Defense Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'Zen edition of Missile Defense: identical rules, 28% slower, separate high score. Click where you want your counter-missile to detonate — the fireball destroys anything that flies through it while it lasts, so the trick is to lead the incoming rather than aim at it. Ideal when you want the loop without the adrenaline — or when you want to see exactly how a pattern works before facing it at full speed.',
  ...
  V('moto-hill', { id: 'moto-hill-turbo', title: 'Moto Hill Climb Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Moto Hill Climb, wound up: everything moves at 135% speed and the reaction windows shrink to match. A side-on physics bike over endless procedurally-generated hills that get taller the further you ride. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Moto Hill Climb is worth something on the Turbo leaderboard.',
  ...
  V('night-rider', { id: 'night-rider-turbo', title: 'Night Rider Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Night Rider Turbo is Night Rider with game time running about a third faster. Ride a neon motorbike up a four-lane night highway that never ends. Every car you skim past without touching pays a 50-point near-miss bonus, so the best line is always the scariest one. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Night Rider.',
  ...
  V('nim', { id: 'nim-turbo', title: 'Nim Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Nim: identical mechanics, 35% more speed, its own leaderboard. Four rows of matches. On your turn take as many as you like, but all from one row. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('nine-mens-morris', { id: 'nine-mens-morris-turbo', title: 'Nine Men’s Morris Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Nine Men’s Morris: identical mechanics, 35% more speed, its own leaderboard. An ancient game in three phases. First you both place nine pieces on the board; then you slide them along the lines; and once you are down to three you may fly anywhere. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('ninja-climb', { id: 'ninja-climb-turbo', title: 'Ninja Climb Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Ninja Climb, wound up: everything moves at 135% speed and the reaction windows shrink to match. A narrow shaft, two walls and a floor of fire that is always coming up behind you. Press jump while touching a wall and you kick off toward the other side, so climbing is a rhythm you have to keep. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Ninja Climb is worth something on the Turbo leaderboard.',
  ...
  V('ninja-slice', { id: 'ninja-slice-turbo', title: 'Ninja Slice Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Ninja Slice, but hurried. A swipe game about timing rather than speed. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('nonogram', { id: 'nonogram-turbo', title: 'Nonogram Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Nonogram. Also called Picross. The numbers beside each row and above each column tell you the lengths of the filled runs, in order, with at least one gap between them. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('one-line', { id: 'one-line-turbo', title: 'One Line Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of One Line: identical mechanics, 35% more speed, its own leaderboard. Trace every line in the figure in a single unbroken stroke, never going over the same line twice. Where you start matters — most of these shapes only work from one or two dots, which is the actual puzzle. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('orbital-defense', { id: 'orbital-defense-turbo', title: 'Orbital Defense Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Orbital Defense, but hurried. Meteors fall in from every angle and you have exactly one shield arc to swing around the planet. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('paint-wars', { id: 'paint-wars-hyper', title: 'Paint Wars Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Paint Wars: same mechanics, 1.7× game speed, separate leaderboard. Skate around the arena leaving your colour on every tile while Rosa and Limey do the same. Ink is the whole game: it drains as you claim tiles (stealing painted ground costs extra), only refills while you ride your own colour, and enemy paint slows you down. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('paper-claim', { id: 'paper-claim-turbo', title: 'Paper Claim Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Paper Claim, but hurried. You start with a small square of territory. Drive outside it and you leave a trail behind you; get back to your own land and everything the loop enclosed becomes yours. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('paper-planes', { id: 'paper-planes-hyper', title: 'Paper Planes Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Paper Planes Hyper is Paper Planes with the clock running 70% faster. Pull the dart back like a slingshot and let it go, then hold to dive when you need speed and let go to stretch the glide — height is the fuel you spend on distance. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Paper Planes record.',
  ...
  V('paper-planes', { id: 'paper-planes-turbo', title: 'Paper Planes Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Paper Planes, wound up: everything moves at 135% speed and the reaction windows shrink to match. Pull the dart back like a slingshot and let it go, then hold to dive when you need speed and let go to stretch the glide — height is the fuel you spend on distance. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Paper Planes is worth something on the Turbo leaderboard.',
  ...
  V('parking-draw', { id: 'parking-draw-hyper', title: 'Parking Draw Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Parking Draw. Every car needs a hand-drawn line from where it sits to the bay painted in its own colour, and a line that clips a concrete block is rejected on the spot. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('parking-draw', { id: 'parking-draw-turbo', title: 'Parking Draw Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Parking Draw, but hurried. Every car needs a hand-drawn line from where it sits to the bay painted in its own colour, and a line that clips a concrete block is rejected on the spot. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('peg-solitaire', { id: 'peg-solitaire-turbo', title: 'Peg Solitaire Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Peg Solitaire, wound up: everything moves at 135% speed and the reaction windows shrink to match. The English cross board: 33 holes, 32 pegs and one gap in the middle. Jump a peg straight over a neighbour into an empty hole and the peg you jumped comes off. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Peg Solitaire is worth something on the Turbo leaderboard.',
  ...
  V('penalty-shootout', { id: 'penalty-shootout-turbo', title: 'Penalty Shootout Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Penalty Shootout, wound up: everything moves at 135% speed and the reaction windows shrink to match. You alternate between taking penalties and keeping them out. Taking one, you drag to pick a spot in the goal; keeping, you commit to diving left, centre or right. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Penalty Shootout is worth something on the Turbo leaderboard.',
  ...
  V('perfect-circle', { id: 'perfect-circle-turbo', title: 'Perfect Circle Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Perfect Circle, wound up: everything moves at 135% speed and the reaction windows shrink to match. One stroke, around the dot, no lifting. Your score multiplies how consistent your radius stayed by how much of the full turn you actually drew, so a beautiful three-quarter arc will not save you. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Perfect Circle is worth something on the Turbo leaderboard.',
  ...
  V('photon-cycles', { id: 'photon-cycles-turbo', title: 'Photon Cycles Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Photon Cycles. Your cycle runs flat out and lays a solid wall behind it; so do one to three rival riders who actively cut across your path. Each round adds speed, and from round three a third cycle joins, then a fourth. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('photon-cycles', { id: 'photon-cycles-zen', title: 'Photon Cycles Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Photon Cycles, tinted cool. Your cycle runs flat out and lays a solid wall behind it; so do one to three rival riders who actively cut across your path. Each round adds speed, and from round three a third cycle joins, then a fourth. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('piano-tap', { id: 'piano-tap-turbo', title: 'Piano Tap Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Piano Tap Turbo is Piano Tap with game time running about a third faster. Four columns of tiles scroll down and exactly one in each row is black. Tap it — or use D, F, J and K — before it reaches the bottom. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Piano Tap.',
  ...
  V('pinball', { id: 'pinball-turbo', title: 'Pinball Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Pinball Turbo is Pinball with game time running about a third faster. A single-screen table with a charging plunger, two flippers and real physics. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Pinball.',
  ...
  V('quick-math', { id: 'quick-math-hyper', title: 'Quick Math Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Quick Math. A sum with an answer already filled in — decide whether it is right. Wrong answers are deliberately close to correct, so you have to actually compute rather than eyeball. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('quick-math', { id: 'quick-math-turbo', title: 'Quick Math Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Quick Math, but hurried. A sum with an answer already filled in — decide whether it is right. Wrong answers are deliberately close to correct, so you have to actually compute rather than eyeball. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('ragdoll-launch', { id: 'ragdoll-launch-hyper', title: 'Ragdoll Launch Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Ragdoll Launch, seventy percent faster, in a hotter palette. Lock the swinging catapult angle with one tap and the pulsing power bar with the next, then watch a seven-joint ragdoll tumble down the valley. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('ragdoll-launch', { id: 'ragdoll-launch-turbo', title: 'Ragdoll Launch Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Ragdoll Launch: identical mechanics, 35% more speed, its own leaderboard. Lock the swinging catapult angle with one tap and the pulsing power bar with the next, then watch a seven-joint ragdoll tumble down the valley. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('reaction-time', { id: 'reaction-time-hyper', title: 'Reaction Time Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Hyper edition of Reaction Time: same mechanics, 1.7× game speed, separate leaderboard. The screen goes red, then turns green after an unpredictable pause of one to four seconds. Click as fast as you can once it does — clicking early makes you retry the round. The best runs come from reading two hazards ahead rather than one — the original rewards that, this one demands it.',
  ...
  V('reaction-time', { id: 'reaction-time-turbo', title: 'Reaction Time Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Reaction Time Turbo is Reaction Time with game time running about a third faster. The screen goes red, then turns green after an unpredictable pause of one to four seconds. Click as fast as you can once it does — clicking early makes you retry the round. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Reaction Time.',
  ...
  V('rhythm-tap', { id: 'rhythm-tap-hyper', title: 'Rhythm Tap Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Rhythm Tap, seventy percent faster, in a hotter palette. Notes drop down four lanes and you hit D, F, J or K as each crosses the line. Timing is graded — dead centre is a PERFECT and worth well over triple a GOOD — and every hit extends your combo, which adds to the score of every note after it. Hyper strips out the breathing room the original gives you; what is left is pure pattern recognition and commitment. Practise in Zen or the original, then come here to see how far it holds.',
  ...
  V('rhythm-tap', { id: 'rhythm-tap-turbo', title: 'Rhythm Tap Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Rhythm Tap: identical mechanics, 35% more speed, its own leaderboard. Notes drop down four lanes and you hit D, F, J or K as each crosses the line. Timing is graded — dead centre is a PERFECT and worth well over triple a GOOD — and every hit extends your combo, which adds to the score of every note after it. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('rise-up', { id: 'rise-up-hyper', title: 'Rise Up Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Rise Up. The balloon climbs by itself and everything else falls toward it. Your shield does not destroy anything — it shoves obstacles aside, so you have to nudge them clear early rather than block at the last second. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('rise-up', { id: 'rise-up-turbo', title: 'Rise Up Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Rise Up, but hurried. The balloon climbs by itself and everything else falls toward it. Your shield does not destroy anything — it shoves obstacles aside, so you have to nudge them clear early rather than block at the last second. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('river-raft', { id: 'river-raft-hyper', title: 'River Raft Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of River Raft. Steer a timber raft down an endless winding river. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('river-raft', { id: 'river-raft-turbo', title: 'River Raft Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'River Raft, but hurried. Steer a timber raft down an endless winding river. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('road-hopper', { id: 'road-hopper-hyper', title: 'Road Hopper Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Road Hopper Hyper is Road Hopper with the clock running 70% faster. Hop across six lanes of traffic, then across a river where the water is the hazard and the logs are the only safe ground — and they carry you sideways while you stand on them. Fill all five bays at the top to win, with thirty seconds allowed for each crossing. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Road Hopper record.',
  ...
  V('road-hopper', { id: 'road-hopper-turbo', title: 'Road Hopper Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Road Hopper, wound up: everything moves at 135% speed and the reaction windows shrink to match. Hop across six lanes of traffic, then across a river where the water is the hazard and the logs are the only safe ground — and they carry you sideways while you stand on them. Fill all five bays at the top to win, with thirty seconds allowed for each crossing. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Road Hopper is worth something on the Turbo leaderboard.',
  ...
  V('roll-block', { id: 'roll-block-hyper', title: 'Roll Block Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Roll Block at 1.7× speed. A block twice as tall as it is wide, and a hole exactly one square across. It tips end over end, so it spends half its time lying flat across two tiles and half standing on one — and it only drops through the hole while standing. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('roll-block', { id: 'roll-block-turbo', title: 'Roll Block Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Roll Block. A block twice as tall as it is wide, and a hole exactly one square across. It tips end over end, so it spends half its time lying flat across two tiles and half standing on one — and it only drops through the hole while standing. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('rolling-ball', { id: 'rolling-ball-hyper', title: 'Rolling Ball Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Rolling Ball Hyper is Rolling Ball with the clock running 70% faster. A marble on a tilting board. The arrow keys lean the whole maze, and the ball keeps rolling long after you stop pushing — so the hard part is not getting somewhere, it is stopping once you arrive. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Rolling Ball record.',
  ...
  V('rolling-ball', { id: 'rolling-ball-turbo', title: 'Rolling Ball Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Rolling Ball, wound up: everything moves at 135% speed and the reaction windows shrink to match. A marble on a tilting board. The arrow keys lean the whole maze, and the ball keeps rolling long after you stop pushing — so the hard part is not getting somewhere, it is stopping once you arrive. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Rolling Ball is worth something on the Turbo leaderboard.',
  ...
  V('rooftop-run', { id: 'rooftop-run-hyper', title: 'Rooftop Run Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Rooftop Run at 1.7× speed. A dusk parkour sprint across an endless skyline with exactly two moves: jump clears the gaps between rooftops, and holding slide gets you under the cyan pipes. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('rooftop-run', { id: 'rooftop-run-turbo', title: 'Rooftop Run Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Rooftop Run. A dusk parkour sprint across an endless skyline with exactly two moves: jump clears the gaps between rooftops, and holding slide gets you under the cyan pipes. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('rope-cut', { id: 'rope-cut-hyper', title: 'Rope Cut Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Rope Cut Hyper is Rope Cut with the clock running 70% faster. A sweet hangs from real rope — cut one strand and it swings on the others, cut the last and it drops. Sixteen levels add bubbles that float the candy upward until you tap them, slack ropes that catch it mid-fall, and spike beds that end the attempt. This is the expert cut: openings that lasted a comfortable half-second in the original are gone in a blink, and the difficulty ramp compounds on top. Hyper keeps its own best score — expect it to be a fraction of your Rope Cut record.',
  ...
  V('rope-cut', { id: 'rope-cut-turbo', title: 'Rope Cut Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Rope Cut, wound up: everything moves at 135% speed and the reaction windows shrink to match. A sweet hangs from real rope — cut one strand and it swings on the others, cut the last and it drops. Sixteen levels add bubbles that float the candy upward until you tap them, slack ropes that catch it mid-fall, and spike beds that end the attempt. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Rope Cut is worth something on the Turbo leaderboard.',
  ...
  V('rotate-rings', { id: 'rotate-rings-hyper', title: 'Rotate Rings Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Rotate Rings at 1.7× speed. Seven procedurally painted scenes — a harbour sunset, a mountain cabin at night, a ringed planet, balloons over a meadow and more — each freshly drawn, then cut into concentric rings that have been twisted out of line. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('rotate-rings', { id: 'rotate-rings-turbo', title: 'Rotate Rings Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Rotate Rings. Seven procedurally painted scenes — a harbour sunset, a mountain cabin at night, a ringed planet, balloons over a meadow and more — each freshly drawn, then cut into concentric rings that have been twisted out of line. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('shadow-leap', { id: 'shadow-leap-turbo', title: 'Shadow Leap Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Shadow Leap, but hurried. You are a shade that moves only by teleporting: tap any stone inside your dashed ring and you are there instantly — but one second after you land, the stone under you shatters, and the ring above your head counts it down. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('shark-escape', { id: 'shark-escape-turbo', title: 'Shark Escape Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Shark Escape, wound up: everything moves at 135% speed and the reaction windows shrink to match. A vertical escape from 600 metres down. Your air drains constantly and the only refills are the ringed bubbles drifting up the column, so the run is a chain of bubble to bubble. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Shark Escape is worth something on the Turbo leaderboard.',
  ...
  V('simon-says', { id: 'simon-says-turbo', title: 'Simon Says Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Simon Says, wound up: everything moves at 135% speed and the reaction windows shrink to match. Four pads light up in a sequence and play a note each; repeat it back. Every round adds one more step, so it becomes a memory test dressed up as a reflex game. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Simon Says is worth something on the Turbo leaderboard.',
  ...
  V('skate-park', { id: 'skate-park-turbo', title: 'Skate Park Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Skate Park, but hurried. A 75-second halfpipe session where every trick is a held key: spin with ←, kickflip with →, grab with ↓, and stack them in one air for bigger points. With the clock running a third faster, hazards bunch up and openings close sooner, and the scoring that ramps in the original ramps here too — just quicker. Separate best score, same controls.',
  ...
  V('ski-slalom', { id: 'ski-slalom-turbo', title: 'Ski Slalom Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Ski Slalom Turbo is Ski Slalom with game time running about a third faster. Carve between forty pairs of slalom flags that swing further off the racing line the lower you get. Pale-blue glare ice barely answers the skis — you keep sliding the way you were already going — so set your line before a patch, not on it. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Ski Slalom.',
  ...
  V('sky-ace', { id: 'sky-ace-turbo', title: 'Sky Ace Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Sky Ace: identical mechanics, 35% more speed, its own leaderboard. A side-view dogfight where physics matters: your bullets drop as they travel, so you aim above distant planes and lead the fast ones. Red scouts fly straight, gunners shoot back, and enemy aces corkscrew through loops that make them maddening to hit. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('sky-hopper', { id: 'sky-hopper-turbo', title: 'Sky Hopper Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Turbo edition of Sky Hopper: identical mechanics, 35% more speed, its own leaderboard. Every platform bounces you back up — you only have to steer. Green springs launch you much higher, cyan pads slide side to side, and orange pads crumble the instant you leave them. The trick is to stop reacting to individual threats and start reading the pattern a beat ahead — the original taught you the pattern, this one tests whether you learned it.',
  ...
  V('slingshot-stars', { id: 'slingshot-stars-turbo', title: 'Slingshot Stars Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'The same Slingshot Stars, wound up: everything moves at 135% speed and the reaction windows shrink to match. Pull back on the comet and let go; from then on the planets steer. Each one bends your path in proportion to its mass, red planets shove you away, and the dotted preview shows the first couple of seconds of the curve. Nothing about the rules changes — only how long you get to respond. A score that felt routine in Slingshot Stars is worth something on the Turbo leaderboard.',
  ...
  V('snake-royale', { id: 'snake-royale-turbo', title: 'Snake Royale Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'Snake Royale Turbo is Snake Royale with game time running about a third faster. A big open arena shared with seven rival snakes. Eat orbs to grow, steer with your mouse, and boost to close a gap — boosting burns length and leaves a trail of orbs behind you. At this pace the same patterns arrive before you have finished reading them, so the safe routes of the original become gambles here. Turbo keeps its own best score, separate from Snake Royale.',
  ...
  V('star-gate', { id: 'star-gate-hyper', title: 'Star Gate Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'The frantic edition of Star Gate. A wrapping planet you patrol at speed, with a radar strip along the top showing the whole ridge at once. Purple landers descend, hook a scientist and haul them to the ceiling — if one makes it, the scientist returns as a mutant that hunts you down. With game time at 170%, hazards stack, gaps close early and there is no slack for a bad first move — but the scoring runs just as fast, so short runs can still post big numbers. Own high-score table.',
  ...
  V('tunnel-digger', { id: 'tunnel-digger-hyper', title: 'Tunnel Digger Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Tunnel Digger at 1.7× speed. You chew tunnels through four bands of soil while red grubs and green fire-breathers hunt you down them. The pump harpoon reaches three tiles along a clear tunnel: latch on, then tap four times to pop — deeper kills pay more. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('tunnel-digger', { id: 'tunnel-digger-turbo', title: 'Tunnel Digger Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Tunnel Digger. You chew tunnels through four bands of soil while red grubs and green fire-breathers hunt you down them. The pump harpoon reaches three tiles along a clear tunnel: latch on, then tap four times to pop — deeper kills pay more. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('tunnel-digger', { id: 'tunnel-digger-zen', title: 'Tunnel Digger Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Tunnel Digger, tinted cool. You chew tunnels through four bands of soil while red grubs and green fire-breathers hunt you down them. The pump harpoon reaches three tiles along a clear tunnel: latch on, then tap four times to pop — deeper kills pay more. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
  ...
  V('tunnel-rush', { id: 'tunnel-rush-hyper', title: 'Tunnel Rush Hyper', emo: '🔥', speed: 1.7, hue: 300, sat: 1.25,
    ...
    description: 'Everything in Tunnel Rush at 1.7× speed. You are falling down a neon tunnel and every gate ahead is a solid ring with one gap in it. Steer around the tunnel wall to line up before the gate reaches you; hitting the ring dead centre scores a Perfect worth triple. Hyper is for players who have the original memorised and want a version where every run is a sprint; survival past the first minute is an achievement, and the leaderboard is separate.',
  ...
  V('tunnel-rush', { id: 'tunnel-rush-turbo', title: 'Tunnel Rush Turbo', emo: '⚡', speed: 1.35, hue: 130, sat: 1.15,
    ...
    description: 'A faster cut of Tunnel Rush. You are falling down a neon tunnel and every gate ahead is a solid ring with one gap in it. Steer around the tunnel wall to line up before the gate reaches you; hitting the ring dead centre scores a Perfect worth triple. Turbo multiplies game time by 1.35, which is enough to turn a comfortable rhythm into a proper reflex test without making it unfair. Learn the original first; bring the muscle memory here.',
  ...
  V('tunnel-rush', { id: 'tunnel-rush-zen', title: 'Tunnel Rush Zen', emo: '🧘', speed: 0.72, hue: 215, sat: 0.9,
    ...
    description: 'A slow-motion cut of Tunnel Rush, tinted cool. You are falling down a neon tunnel and every gate ahead is a solid ring with one gap in it. Steer around the tunnel wall to line up before the gate reaches you; hitting the ring dead centre scores a Perfect worth triple. At three-quarter speed the difficulty ramp still arrives, it just takes its time, so runs last longer and higher scores are realistic for newer players. Your Zen best is tracked on its own.',
