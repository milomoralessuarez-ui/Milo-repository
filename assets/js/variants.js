/* ==========================================================================
   ...
   Generated by tools/build-variants.mjs; 622 remixes.
   ========================================================================== */
(function () {
  'use strict';
  ...
  V('make-24', { id: 'make-24-insane', title: 'Make 24: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Make 24 at 2× — the version for people who found Hyper too polite. Combine all four numbers — each used exactly once — with addition, subtraction, multiplication and division to land on exactly 24. Fractions along the way are fine. At double speed reaction is barely enough; runs are won by knowing what comes next before it appears. Separate leaderboard so the numbers stay honest.',
  ...
  V('mancala', { id: 'mancala-insane', title: 'Mancala: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Mancala: identical mechanics, game time × 2, warm palette, separate best score. One of the oldest board games there is. Lift all the seeds from one of your pits and drop them one per pit going anticlockwise, skipping the opponent’s store. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
  ...
  V('mastermind', { id: 'mastermind-insane', title: 'Mastermind: Insane Mode', emo: '💀', speed: 2, hue: 20, sat: 1.3,
    ...
    description: 'Insane mode for Mastermind: identical mechanics, game time × 2, warm palette, separate best score. A hidden sequence of four colours drawn from six, repeats allowed. Each guess comes back with pegs: a dark peg for a colour that is right and in the right place, a white peg for a colour that is right but misplaced. Treat the first few runs as reconnaissance — even the opening pattern feels new at this pace.',
